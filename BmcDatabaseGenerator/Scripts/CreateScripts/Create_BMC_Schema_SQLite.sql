...
(
	...
	"colourFinishId" INTEGER NULL,		-- Material finish type — FK to ColourFinish lookup table
...
(
	...
	"partTypeId" INTEGER NULL,		-- LDraw part classification — FK to PartType lookup table
