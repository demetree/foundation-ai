...
(
	...
	"avatarImagePath" VARCHAR(250) NULL COLLATE NOCASE,		-- Relative path to the user's avatar image
	"profileBannerImagePath" VARCHAR(250) NULL COLLATE NOCASE,		-- Relative path to the profile banner/cover image
