...
(
	...
	"isTransparent" BOOLEAN NOT NULL DEFAULT false,		-- Whether this colour is transparent
	"isMetallic" BOOLEAN NOT NULL DEFAULT false,		-- Whether this colour has a metallic finish
	"sequence" INT NULL,		-- Sequence to use for sorting.
	"objectGuid" VARCHAR(50) NOT NULL UNIQUE,		-- Unique identifier for this table.
	"active" BOOLEAN NOT NULL DEFAULT true,		-- Active from a business perspective flag.
	"deleted" BOOLEAN NOT NULL DEFAULT false,		-- Soft deletion flag.
...
INSERT INTO "BMC"."BrickColour" ( "name", "ldrawColourCode", "hexRgb", "alpha", "isTransparent", "isMetallic", "sequence", "objectGuid" ) VALUES  ( 'Black', 0, '#1B2A34', 255, false, false, 1, 'c0100001-0001-4000-8000-000000000001' );

INSERT INTO "BMC"."BrickColour" ( "name", "ldrawColourCode", "hexRgb", "alpha", "isTransparent", "isMetallic", "sequence", "objectGuid" ) VALUES  ( 'Blue', 1, '#1E5AA8', 255, false, false, 2, 'c0100001-0001-4000-8000-000000000002' );

INSERT INTO "BMC"."BrickColour" ( "name", "ldrawColourCode", "hexRgb", "alpha", "isTransparent", "isMetallic", "sequence", "objectGuid" ) VALUES  ( 'Green', 2, '#00852B', 255, false, false, 3, 'c0100001-0001-4000-8000-000000000003' );

INSERT INTO "BMC"."BrickColour" ( "name", "ldrawColourCode", "hexRgb", "alpha", "isTransparent", "isMetallic", "sequence", "objectGuid" ) VALUES  ( 'Red', 4, '#B40000', 255, false, false, 4, 'c0100001-0001-4000-8000-000000000004' );

INSERT INTO "BMC"."BrickColour" ( "name", "ldrawColourCode", "hexRgb", "alpha", "isTransparent", "isMetallic", "sequence", "objectGuid" ) VALUES  ( 'Yellow', 14, '#FFD67F', 255, false, false, 5, 'c0100001-0001-4000-8000-000000000005' );

INSERT INTO "BMC"."BrickColour" ( "name", "ldrawColourCode", "hexRgb", "alpha", "isTransparent", "isMetallic", "sequence", "objectGuid" ) VALUES  ( 'White', 15, '#F4F4F4', 255, false, false, 6, 'c0100001-0001-4000-8000-000000000006' );

INSERT INTO "BMC"."BrickColour" ( "name", "ldrawColourCode", "hexRgb", "alpha", "isTransparent", "isMetallic", "sequence", "objectGuid" ) VALUES  ( 'Light Bluish Grey', 71, '#A0A5A9', 255, false, false, 7, 'c0100001-0001-4000-8000-000000000007' );

INSERT INTO "BMC"."BrickColour" ( "name", "ldrawColourCode", "hexRgb", "alpha", "isTransparent", "isMetallic", "sequence", "objectGuid" ) VALUES  ( 'Dark Bluish Grey', 72, '#6C6E68', 255, false, false, 8, 'c0100001-0001-4000-8000-000000000008' );
