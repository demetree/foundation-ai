/*
   ...
   GENERATED SERVICE FOR THE AUDITUSERAGENT TABLE - DO NOT MODIFY DIRECTLY
   =======================================================================================
   This is the default data interaction service for the AuditUserAgent table.
...
export class AuditUserAgentData {
    ...
    public get AuditEventsCount$(): Observable<bigint | number> {
        if (this._auditEventsCount$ === null) {
            this._auditEventsCount$ = AuditEventService.Instance.GetAuditEventsRowCount({auditUserAgentId: this.id,
              active: true,
              deleted: false
            });
        }
  ...
  private clearAllLazyCaches(): void {
     ...
     * 
     * Usage in components:
     *   this.auditUserAgent.AuditEvents.then(auditUserAgents => { ... })
     *   or
     *   await this.auditUserAgent.auditUserAgents
     *
    */
