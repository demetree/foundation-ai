...
//
interface AuditEventErrorMessageFormValues {
...
export class AuditEventErrorMessageAddEditComponent {
  ...
  //
  @Input() preSeededData: Partial<AuditEventErrorMessageFormValues> | null = null;
  ...
  public auditEventErrorMessageForm: FormGroup = this.fb.group({
  ...
  openModal(auditEventErrorMessageData?: AuditEventErrorMessageData) {
    ...
    if (auditEventErrorMessageData != null) {
      ...
      if (this.preSeededData !== null && this.preSeededData !== undefined) {
        this.auditEventErrorMessageForm.patchValue(this.preSeededData);
      }
    ...
    for (index = 0; index < this.hiddenFields.length; index++) {
      ...
      const control = this.auditEventErrorMessageForm.get(fieldName);
      if (control !== null) {
