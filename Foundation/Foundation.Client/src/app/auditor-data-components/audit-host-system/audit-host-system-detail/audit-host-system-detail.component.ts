...
//
interface AuditHostSystemFormValues {
  name: string,
...
export class AuditHostSystemDetailComponent implements OnInit, CanComponentDeactivate {
  ...
  //
  @Input() preSeededData: Partial<AuditHostSystemFormValues> | null = null;
  ...
  public auditHostSystemForm: FormGroup = this.fb.group({
  ...
  ngOnInit(): void {
    ...
    if (this.auditHostSystemId === 'new' ||
      ...
      if (this.preSeededData !== null && this.preSeededData !== undefined) {
        this.auditHostSystemForm.patchValue(this.preSeededData);
      }
    ...
    for (index = 0; index < this.hiddenFields.length; index++) {
      ...
      const control = this.auditHostSystemForm.get(fieldName);
      if (control !== null) {
