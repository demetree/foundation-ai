...
//
interface AuditSessionFormValues {
  name: string,
...
export class AuditSessionDetailComponent implements OnInit, CanComponentDeactivate {
  ...
  //
  @Input() preSeededData: Partial<AuditSessionFormValues> | null = null;
  ...
  public auditSessionForm: FormGroup = this.fb.group({
  ...
  ngOnInit(): void {
    ...
    if (this.auditSessionId === 'new' ||
      ...
      if (this.preSeededData !== null && this.preSeededData !== undefined) {
        this.auditSessionForm.patchValue(this.preSeededData);
      }
    ...
    for (index = 0; index < this.hiddenFields.length; index++) {
      ...
      const control = this.auditSessionForm.get(fieldName);
      if (control !== null) {
