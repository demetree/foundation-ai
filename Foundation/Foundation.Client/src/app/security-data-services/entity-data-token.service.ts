...
export class EntityDataTokenData {
    ...
    public get EntityDataTokenEventsCount$(): Observable<bigint | number> {
        if (this._entityDataTokenEventsCount$ === null) {
            this._entityDataTokenEventsCount$ = EntityDataTokenEventService.Instance.GetEntityDataTokenEventsRowCount({entityDataTokenId: this.id,
              active: true,
              deleted: false
            });
        }
...
export class EntityDataTokenService extends SecureEndpointBase {
    ...
    public userIsSecurityEntityDataTokenReader(): boolean {
        ...
        if (userIsSecurityEntityDataTokenReader == true) {
            ...
            if (user != null) {
                userIsSecurityEntityDataTokenReader = user.readPermission >= 1;
            } else {
    ...
    public userIsSecurityEntityDataTokenWriter(): boolean {
        ...
        if (userIsSecurityEntityDataTokenWriter == true) {
          ...
          if (user != null) {
            userIsSecurityEntityDataTokenWriter = user.writePermission >= 50;
          } else {
