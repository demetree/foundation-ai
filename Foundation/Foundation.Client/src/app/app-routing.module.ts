...
//
  ...
  {path: 'ipaddresslocations', component: IpAddressLocationListingComponent, canActivate: [AuthGuard], canDeactivate: [UnsavedChangesGuard], title: 'Ip Address Locations' },
  {path: 'ipaddresslocations/new', component: IpAddressLocationDetailComponent, canActivate: [AuthGuard], canDeactivate: [UnsavedChangesGuard], title: 'Create Ip Address Location' },
  {path: 'ipaddresslocations/:ipAddressLocationId', component: IpAddressLocationDetailComponent, canActivate: [AuthGuard], canDeactivate: [UnsavedChangesGuard], title: 'Edit Ip Address Location' },
  {path: 'ipaddresslocation/:ipAddressLocationId', component: IpAddressLocationDetailComponent, canActivate: [AuthGuard], canDeactivate: [UnsavedChangesGuard], title: 'Edit Ip Address Location' },
  {path: 'ipaddresslocation',  redirectTo: 'ipaddresslocations'},
  ...
  {path: 'usersessions', component: UserSessionListingComponent, canActivate: [AuthGuard], canDeactivate: [UnsavedChangesGuard], title: 'User Sessions' },
  {path: 'usersessions/new', component: UserSessionDetailComponent, canActivate: [AuthGuard], canDeactivate: [UnsavedChangesGuard], title: 'Create User Session' },
  {path: 'usersessions/:userSessionId', component: UserSessionDetailComponent, canActivate: [AuthGuard], canDeactivate: [UnsavedChangesGuard], title: 'Edit User Session' },
  {path: 'usersession/:userSessionId', component: UserSessionDetailComponent, canActivate: [AuthGuard], canDeactivate: [UnsavedChangesGuard], title: 'Edit User Session' },
  {path: 'usersession',  redirectTo: 'usersessions'},
//
...
//
  ...
  {path: 'telemetryapplicationmetrics', component: TelemetryApplicationMetricListingComponent, canActivate: [AuthGuard], canDeactivate: [UnsavedChangesGuard], title: 'Telemetry Application Metrics' },
  {path: 'telemetryapplicationmetrics/new', component: TelemetryApplicationMetricDetailComponent, canActivate: [AuthGuard], canDeactivate: [UnsavedChangesGuard], title: 'Create Telemetry Application Metric' },
  {path: 'telemetryapplicationmetrics/:telemetryApplicationMetricId', component: TelemetryApplicationMetricDetailComponent, canActivate: [AuthGuard], canDeactivate: [UnsavedChangesGuard], title: 'Edit Telemetry Application Metric' },
  {path: 'telemetryapplicationmetric/:telemetryApplicationMetricId', component: TelemetryApplicationMetricDetailComponent, canActivate: [AuthGuard], canDeactivate: [UnsavedChangesGuard], title: 'Edit Telemetry Application Metric' },
  {path: 'telemetryapplicationmetric',  redirectTo: 'telemetryapplicationmetrics'},
