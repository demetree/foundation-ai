...
//
interface SecurityDepartmentUserFormValues {
...
export class SecurityDepartmentUserAddEditComponent {
  ...
  //
  @Input() preSeededData: Partial<SecurityDepartmentUserFormValues> | null = null;
  ...
  public securityDepartmentUserForm: FormGroup = this.fb.group({
  ...
  openModal(securityDepartmentUserData?: SecurityDepartmentUserData) {
    ...
    if (securityDepartmentUserData != null) {
      ...
      if (this.preSeededData !== null && this.preSeededData !== undefined) {
        this.securityDepartmentUserForm.patchValue(this.preSeededData);
      }
    ...
    for (index = 0; index < this.hiddenFields.length; index++) {
      ...
      const control = this.securityDepartmentUserForm.get(fieldName);
      if (control !== null) {
