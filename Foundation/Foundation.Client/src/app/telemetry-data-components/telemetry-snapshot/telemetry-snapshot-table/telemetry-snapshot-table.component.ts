...
export class TelemetrySnapshotTableComponent implements OnInit, OnChanges, AfterViewInit {
 ...
 /**
  ...
  private buildDefaultColumns(): void {
    ...
    { key: 'memoryPercent', label: 'Memory Percent', width: undefined },
    { key: 'systemMemoryPercent', label: 'System Memory Percent', width: undefined },
    { key: 'cpuPercent', label: 'Cpu Percent', width: undefined },
    { key: 'systemCpuPercent', label: 'System Cpu Percent', width: undefined },
  ...
  public handleAdd(): void {
    if (this.addEditTelemetrySnapshotComponent)
    {
        this.addEditTelemetrySnapshotComponent.openModal(); // Open in add mode (no data)
    }
}
