...
namespace Foundation.BMC.Database
{
	...
	//
	public partial class BuildStepAnnotation : IVersionTrackedEntity<BuildStepAnnotation>, IAnonymousConvertible
	{
        /// <summary>
        ...
        public static ChangeHistoryToolset<BuildStepAnnotation, BuildStepAnnotationChangeHistory> GetChangeHistoryToolsetForWriting(BMCContext context, Foundation.Security.Database.SecurityUser securityUser, bool insideTransaction = false, CancellationToken cancellationToken = default)
        {
            if (context == null)
            {
            ...
            // 
            return new ChangeHistoryToolset<BuildStepAnnotation, BuildStepAnnotationChangeHistory>(context, securityUser.id, insideTransaction, cancellationToken);
        }
        ...
        /// <exception cref="ArgumentNullException"></exception>
        /// <exception cref="Exception"></exception>
        public static ChangeHistoryToolset<BuildStepAnnotation, BuildStepAnnotationChangeHistory> GetChangeHistoryToolsetForReading(BMCContext context, CancellationToken cancellationToken = default)
        {
            return new ChangeHistoryToolset<BuildStepAnnotation, BuildStepAnnotationChangeHistory>(context, cancellationToken);
        }
        ...
        /// <returns></returns>
        /// <exception cref="Exception"></exception>
        public async Task<VersionInformation<BuildStepAnnotation>> GetThisVersionAsync(bool includeData = false, CancellationToken cancellationToken = default)
        {
        ...
        /// <returns></returns>
        /// <exception cref="Exception"></exception>
        public async Task<VersionInformation<BuildStepAnnotation>> GetFirstVersionAsync(bool includeData = true, CancellationToken cancellationToken = default)
        {
        ...
        /// <returns></returns>
        /// <exception cref="Exception"></exception>
        public async Task<VersionInformation<BuildStepAnnotation>> GetVersionAtTimeAsync(DateTime pointInTime, bool includeData = true, CancellationToken cancellationToken = default)
        {
            ...
            {
                throw new Exception($"No change history found for point in time {pointInTime.ToString("s")} of this BuildStepAnnotation entity.");
            }

            VersionInformation<BuildStepAnnotation> version = new VersionInformation<BuildStepAnnotation>();
        ...
        /// <returns></returns>
        /// <exception cref="Exception"></exception>
        public async Task<VersionInformation<BuildStepAnnotation>> GetVersionAsync(int versionNumber, bool includeData = true, CancellationToken cancellationToken = default)
        {
            if (_contextForVersionInquiry == null || _tenantGuidForVersionInquiry == Guid.Empty)
            {
            ...
            if (versionAudit == null)
            {
                throw new Exception($"No change history found for version {versionNumber} of this BuildStepAnnotation entity.");
            }
        ...
        /// <returns></returns>
        /// <exception cref="Exception"></exception>
        public async Task<List<VersionInformation<BuildStepAnnotation>>> GetAllVersionsAsync(bool includeData = true, CancellationToken cancellationToken = default)
        {
            if (_contextForVersionInquiry == null || _tenantGuidForVersionInquiry == Guid.Empty)
            {
            ...
            List <VersionInformation<BuildStepAnnotation>> versions = new List<VersionInformation<BuildStepAnnotation>>();
		...
		public static object CreateAnonymous(Database.BuildStepAnnotation buildStepAnnotation)
		{
			...
			return new {
				...
				versionNumber = buildStepAnnotation.versionNumber,
