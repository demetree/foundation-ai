...
namespace Foundation.BMC.Database
{
	...
	//
	public partial class MocCollaborator : IVersionTrackedEntity<MocCollaborator>, IAnonymousConvertible
	{
        /// <summary>
        ...
        public static ChangeHistoryToolset<MocCollaborator, MocCollaboratorChangeHistory> GetChangeHistoryToolsetForWriting(BMCContext context, Foundation.Security.Database.SecurityUser securityUser, bool insideTransaction = false, CancellationToken cancellationToken = default)
        {
            if (context == null)
            {
            ...
            // 
            return new ChangeHistoryToolset<MocCollaborator, MocCollaboratorChangeHistory>(context, securityUser.id, insideTransaction, cancellationToken);
        }
        ...
        /// <exception cref="ArgumentNullException"></exception>
        /// <exception cref="Exception"></exception>
        public static ChangeHistoryToolset<MocCollaborator, MocCollaboratorChangeHistory> GetChangeHistoryToolsetForReading(BMCContext context, CancellationToken cancellationToken = default)
        {
            return new ChangeHistoryToolset<MocCollaborator, MocCollaboratorChangeHistory>(context, cancellationToken);
        }
        ...
        /// <returns></returns>
        /// <exception cref="Exception"></exception>
        public async Task<VersionInformation<MocCollaborator>> GetThisVersionAsync(bool includeData = false, CancellationToken cancellationToken = default)
        {
        ...
        /// <returns></returns>
        /// <exception cref="Exception"></exception>
        public async Task<VersionInformation<MocCollaborator>> GetFirstVersionAsync(bool includeData = true, CancellationToken cancellationToken = default)
        {
        ...
        /// <returns></returns>
        /// <exception cref="Exception"></exception>
        public async Task<VersionInformation<MocCollaborator>> GetVersionAtTimeAsync(DateTime pointInTime, bool includeData = true, CancellationToken cancellationToken = default)
        {
            ...
            {
                throw new Exception($"No change history found for point in time {pointInTime.ToString("s")} of this MocCollaborator entity.");
            }

            VersionInformation<MocCollaborator> version = new VersionInformation<MocCollaborator>();
        ...
        /// <returns></returns>
        /// <exception cref="Exception"></exception>
        public async Task<VersionInformation<MocCollaborator>> GetVersionAsync(int versionNumber, bool includeData = true, CancellationToken cancellationToken = default)
        {
            if (_contextForVersionInquiry == null || _tenantGuidForVersionInquiry == Guid.Empty)
            {
            ...
            if (versionAudit == null)
            {
                throw new Exception($"No change history found for version {versionNumber} of this MocCollaborator entity.");
            }
        ...
        /// <returns></returns>
        /// <exception cref="Exception"></exception>
        public async Task<List<VersionInformation<MocCollaborator>>> GetAllVersionsAsync(bool includeData = true, CancellationToken cancellationToken = default)
        {
            if (_contextForVersionInquiry == null || _tenantGuidForVersionInquiry == Guid.Empty)
            {
            ...
            List <VersionInformation<MocCollaborator>> versions = new List<VersionInformation<MocCollaborator>>();
		...
		public static object CreateAnonymous(Database.MocCollaborator mocCollaborator)
		{
			...
			return new {
				...
				versionNumber = mocCollaborator.versionNumber,
