...
(
	...
	"dateTimeCreated" TIMESTAMP NOT NULL,		-- When the notification was created.
	"dateTimeDistributed" TIMESTAMP NULL,		-- When the notification was distributed.
	"distributionCompleted" BOOLEAN NOT NULL DEFAULT false,		-- Control flag to mark whether or not this notification has been distributed to the notificationUser table or not
...
(
	...
	CONSTRAINT "notificationId" FOREIGN KEY ("notificationId") REFERENCES "Scheduler"."Notification"("id")		-- Foreign key to the Notification table.
);
...
(
	...
	"dateTimeCreated" TIMESTAMP NOT NULL,		-- When this notification attachment was created.
	...
	"contentData" BYTEA NOT NULL,		-- Part of the binary data field setup
...
(
	...
	"userId" INT NOT NULL,
	"data" TEXT NOT NULL,		-- This stores the JSON representing the object's historical state.
	CONSTRAINT "notificationAttachmentId" FOREIGN KEY ("notificationAttachmentId") REFERENCES "Scheduler"."NotificationAttachment"("id")		-- Foreign key to the NotificationAttachment table.
);
...
CREATE INDEX "I_NotificationAttachmentChangeHistory_tenantGuid_notificationAt" ON "Scheduler"."NotificationAttachmentChangeHistory" ("tenantGuid", "notificationAttachmentId") INCLUDE ( versionNumber, timeStamp, userId )
;
...
(
	...
	"acknowledged" BOOLEAN NOT NULL DEFAULT false,		-- Whether or not the notification has been acknowledged.
	"dateTimeAcknowledged" TIMESTAMP NULL,		-- When the notification was acknowledged.
	"objectGuid" VARCHAR(50) NOT NULL UNIQUE,		-- Unique identifier for this table.
	"active" BOOLEAN NOT NULL DEFAULT true,		-- Active from a business perspective flag.
	"deleted" BOOLEAN NOT NULL DEFAULT false,		-- Soft deletion flag.
	CONSTRAINT "notificationId" FOREIGN KEY ("notificationId") REFERENCES "Scheduler"."Notification"("id")		-- Foreign key to the Notification table.
...
(
	...
	"dateTimeCreated" TIMESTAMP NOT NULL,		-- When the conversation was created.
	...
	"isPublic" BOOLEAN NULL,		-- Whether or not the conversation is public
	"userId" INT NULL,		-- Optional target user for this conversation.  Resolved by IMessagingUserResolver.
	"objectGuid" VARCHAR(50) NOT NULL UNIQUE,		-- Unique identifier for this table.
	"active" BOOLEAN NOT NULL DEFAULT true,		-- Active from a business perspective flag.
	"deleted" BOOLEAN NOT NULL DEFAULT false,		-- Soft deletion flag.
	CONSTRAINT "conversationTypeId" FOREIGN KEY ("conversationTypeId") REFERENCES "Scheduler"."ConversationType"("id")		-- Foreign key to the ConversationType table.
);
...
(
	...
	"dateTimeAdded" TIMESTAMP NOT NULL,		-- When this user was added to the conversation.
	"objectGuid" VARCHAR(50) NOT NULL UNIQUE,		-- Unique identifier for this table.
	"active" BOOLEAN NOT NULL DEFAULT true,		-- Active from a business perspective flag.
	"deleted" BOOLEAN NOT NULL DEFAULT false,		-- Soft deletion flag.
	CONSTRAINT "conversationId" FOREIGN KEY ("conversationId") REFERENCES "Scheduler"."Conversation"("id")		-- Foreign key to the Conversation table.
);
...
(
	...
	"isPrivate" BOOLEAN NOT NULL DEFAULT false,		-- Whether or not this channel is private.  Private channels are invitation-only and do not appear in the channel browser.
	"isPinned" BOOLEAN NOT NULL DEFAULT false,		-- Whether or not this channel is pinned in the UI.  Pinned channels appear at the top of the channel list.
	"versionNumber" INT NOT NULL DEFAULT 1,		-- The version number of this record.  Increased by one each time the record changes, and the change history is tracked in the table's change history table.
	"objectGuid" VARCHAR(50) NOT NULL UNIQUE,		-- Unique identifier for this table.
	"active" BOOLEAN NOT NULL DEFAULT true,		-- Active from a business perspective flag.
	"deleted" BOOLEAN NOT NULL DEFAULT false,		-- Soft deletion flag.
...
(
	...
	"userId" INT NOT NULL,
	"data" TEXT NOT NULL,		-- This stores the JSON representing the object's historical state.
	CONSTRAINT "conversationChannelId" FOREIGN KEY ("conversationChannelId") REFERENCES "Scheduler"."ConversationChannel"("id")		-- Foreign key to the ConversationChannel table.
);
...
CREATE INDEX "I_ConversationChannelChangeHistory_tenantGuid_conversationChann" ON "Scheduler"."ConversationChannelChangeHistory" ("tenantGuid", "conversationChannelId") INCLUDE ( versionNumber, timeStamp, userId )
;
...
(
	...
	"dateTimeCreated" TIMESTAMP NOT NULL,		-- When this message was created.
	"message" TEXT NOT NULL,
	...
	"isScheduled" BOOLEAN NOT NULL DEFAULT false,		-- Whether this message is scheduled for future delivery.
	"scheduledDateTime" TIMESTAMP NULL,		-- When the scheduled message should be released.  Null if not scheduled.
	"versionNumber" INT NOT NULL DEFAULT 1,		-- The version number of this record.  Increased by one each time the record changes, and the change history is tracked in the table's change history table.
	"objectGuid" VARCHAR(50) NOT NULL UNIQUE,		-- Unique identifier for this table.
	"active" BOOLEAN NOT NULL DEFAULT true,		-- Active from a business perspective flag.
	"deleted" BOOLEAN NOT NULL DEFAULT false,		-- Soft deletion flag.
	CONSTRAINT "conversationId" FOREIGN KEY ("conversationId") REFERENCES "Scheduler"."Conversation"("id"),		-- Foreign key to the Conversation table.
	CONSTRAINT "parentConversationMessageId" FOREIGN KEY ("parentConversationMessageId") REFERENCES "Scheduler"."ConversationMessage"("id"),		-- Foreign key to the ConversationMessage table.
	CONSTRAINT "conversationChannelId" FOREIGN KEY ("conversationChannelId") REFERENCES "Scheduler"."ConversationChannel"("id")		-- Foreign key to the ConversationChannel table.
);
...
(
	...
	"userId" INT NOT NULL,
	"data" TEXT NOT NULL,		-- This stores the JSON representing the object's historical state.
	CONSTRAINT "conversationMessageId" FOREIGN KEY ("conversationMessageId") REFERENCES "Scheduler"."ConversationMessage"("id")		-- Foreign key to the ConversationMessage table.
);
...
CREATE INDEX "I_ConversationMessageChangeHistory_tenantGuid_conversationMessa" ON "Scheduler"."ConversationMessageChangeHistory" ("tenantGuid", "conversationMessageId") INCLUDE ( versionNumber, timeStamp, userId )
;
...
(
	...
	"dateTimeCreated" TIMESTAMP NOT NULL,		-- When this conversation message attachment was created.
	"contentFileName" VARCHAR(250) NOT NULL,		-- Part of the binary data field setup
	"contentSize" BIGINT NOT NULL,		-- Part of the binary data field setup
	"contentData" BYTEA NOT NULL,		-- Part of the binary data field setup
	"contentMimeType" VARCHAR(100) NOT NULL,		-- Part of the binary data field setup
...
CREATE INDEX "I_ConversationMessageAttachment_tenantGuid_conversationMessageI" ON "Scheduler"."ConversationMessageAttachment" ("tenantGuid", "conversationMessageId")
;
...
(
	...
	"userId" INT NOT NULL,
	"data" TEXT NOT NULL,		-- This stores the JSON representing the object's historical state.
	CONSTRAINT "conversationMessageAttachmentId" FOREIGN KEY ("conversationMessageAttachmentId") REFERENCES "Scheduler"."ConversationMessageAttachment"("id")		-- Foreign key to the ConversationMessageAttachment table.
);
...
CREATE INDEX "I_ConversationMessageAttachmentChangeHistory_tenantGuid_version" ON "Scheduler"."ConversationMessageAttachmentChangeHistory" ("tenantGuid", "versionNumber")
;

-- Index on the ConversationMessageAttachmentChangeHistory table's tenantGuid,timeStamp fields.
CREATE INDEX "I_ConversationMessageAttachmentChangeHistory_tenantGuid_timeSta" ON "Scheduler"."ConversationMessageAttachmentChangeHistory" ("tenantGuid", "timeStamp")
;
...
CREATE INDEX "I_ConversationMessageAttachmentChangeHistory_tenantGuid_convers" ON "Scheduler"."ConversationMessageAttachmentChangeHistory" ("tenantGuid", "conversationMessageAttachmentId") INCLUDE ( versionNumber, timeStamp, userId )
;
...
(
	...
	"dateTimeCreated" TIMESTAMP NOT NULL,		-- When this conversation message user was created.
	"acknowledged" BOOLEAN NOT NULL DEFAULT false,
	"dateTimeAcknowledged" TIMESTAMP NOT NULL,		-- When this conversation message user was acknowledge by the user.  For messages, this may be auto acknowledged once the data is read and shown.  Up to the UI to decide when to mark it as acknowledged..
	"objectGuid" VARCHAR(50) NOT NULL UNIQUE,		-- Unique identifier for this table.
	"active" BOOLEAN NOT NULL DEFAULT true,		-- Active from a business perspective flag.
	"deleted" BOOLEAN NOT NULL DEFAULT false,		-- Soft deletion flag.
	CONSTRAINT "conversationMessageId" FOREIGN KEY ("conversationMessageId") REFERENCES "Scheduler"."ConversationMessage"("id")		-- Foreign key to the ConversationMessage table.
...
(
	...
	"dateTimeCreated" TIMESTAMP NOT NULL,		-- When this reaction was created.
	"objectGuid" VARCHAR(50) NOT NULL UNIQUE,		-- Unique identifier for this table.
	"active" BOOLEAN NOT NULL DEFAULT true,		-- Active from a business perspective flag.
	"deleted" BOOLEAN NOT NULL DEFAULT false,		-- Soft deletion flag.
	CONSTRAINT "conversationMessageId" FOREIGN KEY ("conversationMessageId") REFERENCES "Scheduler"."ConversationMessage"("id")		-- Foreign key to the ConversationMessage table.
...
CREATE INDEX "I_ConversationMessageReaction_conversationMessageId_active_dele" ON "Scheduler"."ConversationMessageReaction" ("conversationMessageId", "active", "deleted")
;
...
(
	...
	"dateTimePinned" TIMESTAMP NOT NULL,		-- When this message was pinned.
	"objectGuid" VARCHAR(50) NOT NULL UNIQUE,		-- Unique identifier for this table.
	"active" BOOLEAN NOT NULL DEFAULT true,		-- Active from a business perspective flag.
	"deleted" BOOLEAN NOT NULL DEFAULT false,		-- Soft deletion flag.
	CONSTRAINT "conversationId" FOREIGN KEY ("conversationId") REFERENCES "Scheduler"."Conversation"("id"),		-- Foreign key to the Conversation table.
...
(
	...
	"fetchedDateTime" TIMESTAMP NOT NULL,		-- When the preview data was fetched from the URL.
	"versionNumber" INT NOT NULL DEFAULT 1,		-- The version number of this record.  Increased by one each time the record changes, and the change history is tracked in the table's change history table.
	"objectGuid" VARCHAR(50) NOT NULL UNIQUE,		-- Unique identifier for this table.
	"active" BOOLEAN NOT NULL DEFAULT true,		-- Active from a business perspective flag.
	"deleted" BOOLEAN NOT NULL DEFAULT false,		-- Soft deletion flag.
...
CREATE INDEX "I_ConversationMessageLinkPreview_tenantGuid_conversationMessage" ON "Scheduler"."ConversationMessageLinkPreview" ("tenantGuid", "conversationMessageId")
;
...
CREATE INDEX "I_ConversationMessageLinkPreview_conversationMessageId_active_d" ON "Scheduler"."ConversationMessageLinkPreview" ("conversationMessageId", "active", "deleted")
;
...
(
	...
	"userId" INT NOT NULL,
	"data" TEXT NOT NULL,		-- This stores the JSON representing the object's historical state.
	CONSTRAINT "conversationMessageLinkPreviewId" FOREIGN KEY ("conversationMessageLinkPreviewId") REFERENCES "Scheduler"."ConversationMessageLinkPreview"("id")		-- Foreign key to the ConversationMessageLinkPreview table.
);
...
CREATE INDEX "I_ConversationMessageLinkPreviewChangeHistory_tenantGuid_versio" ON "Scheduler"."ConversationMessageLinkPreviewChangeHistory" ("tenantGuid", "versionNumber")
;

-- Index on the ConversationMessageLinkPreviewChangeHistory table's tenantGuid,timeStamp fields.
CREATE INDEX "I_ConversationMessageLinkPreviewChangeHistory_tenantGuid_timeSt" ON "Scheduler"."ConversationMessageLinkPreviewChangeHistory" ("tenantGuid", "timeStamp")
;
...
CREATE INDEX "I_ConversationMessageLinkPreviewChangeHistory_tenantGuid_conver" ON "Scheduler"."ConversationMessageLinkPreviewChangeHistory" ("tenantGuid", "conversationMessageLinkPreviewId") INCLUDE ( versionNumber, timeStamp, userId )
;
...
(
	...
	"lastSeenDateTime" TIMESTAMP NOT NULL,		-- The last time this user was seen connected.
	"lastActivityDateTime" TIMESTAMP NOT NULL,		-- The last time this user performed an action (sent a message, reacted, etc).
...
(
	...
	"lastReadDateTime" TIMESTAMP NULL,		-- When the user last read the thread.
	"objectGuid" VARCHAR(50) NOT NULL UNIQUE,		-- Unique identifier for this table.
	"active" BOOLEAN NOT NULL DEFAULT true,		-- Active from a business perspective flag.
	"deleted" BOOLEAN NOT NULL DEFAULT false,		-- Soft deletion flag.
	CONSTRAINT "conversationId" FOREIGN KEY ("conversationId") REFERENCES "Scheduler"."Conversation"("id"),		-- Foreign key to the Conversation table.
...
(
	...
	"dateTimeCreated" TIMESTAMP NOT NULL,		-- When the bookmark was created.
	"objectGuid" VARCHAR(50) NOT NULL UNIQUE,		-- Unique identifier for this table.
	"active" BOOLEAN NOT NULL DEFAULT true,		-- Active from a business perspective flag.
	"deleted" BOOLEAN NOT NULL DEFAULT false,		-- Soft deletion flag.
	CONSTRAINT "conversationMessageId" FOREIGN KEY ("conversationMessageId") REFERENCES "Scheduler"."ConversationMessage"("id")		-- Foreign key to the ConversationMessage table.
...
(
	...
	"success" BOOLEAN NOT NULL DEFAULT false,		-- Whether the delivery attempt was successful.
	...
	"dateTimeCreated" TIMESTAMP NOT NULL,		-- When this delivery attempt was made.
	"objectGuid" VARCHAR(50) NOT NULL UNIQUE,		-- Unique identifier for this table.
	"active" BOOLEAN NOT NULL DEFAULT true,		-- Active from a business perspective flag.
	"deleted" BOOLEAN NOT NULL DEFAULT false		-- Soft deletion flag.
...
(
	...
	"enabled" BOOLEAN NOT NULL DEFAULT false,		-- Whether this provider is enabled for this tenant.
	"configurationJson" TEXT NULL,		-- Provider-specific configuration stored as JSON.  Structure varies by provider type.
	"dateTimeModified" TIMESTAMP NOT NULL,		-- When this configuration was last modified.
...
(
	...
	"dateTimeReviewed" TIMESTAMP NULL,		-- When the flag was reviewed.
	"resolutionNotes" VARCHAR(1000) NULL,		-- Notes from the reviewer about the resolution.
	"dateTimeCreated" TIMESTAMP NOT NULL,		-- When the flag was created.
	"objectGuid" VARCHAR(50) NOT NULL UNIQUE,		-- Unique identifier for this table.
	"active" BOOLEAN NOT NULL DEFAULT true,		-- Active from a business perspective flag.
	"deleted" BOOLEAN NOT NULL DEFAULT false,		-- Soft deletion flag.
	CONSTRAINT "conversationMessageId" FOREIGN KEY ("conversationMessageId") REFERENCES "Scheduler"."ConversationMessage"("id")		-- Foreign key to the ConversationMessage table.
...
(
	...
	"dateTimeCreated" TIMESTAMP NOT NULL,		-- When the action was performed.
	"objectGuid" VARCHAR(50) NOT NULL UNIQUE,		-- Unique identifier for this table.
	"active" BOOLEAN NOT NULL DEFAULT true,		-- Active from a business perspective flag.
	"deleted" BOOLEAN NOT NULL DEFAULT false		-- Soft deletion flag.
...
(
	...
	"startDateTime" TIMESTAMP NOT NULL,		-- When the call was initiated.
	"answerDateTime" TIMESTAMP NULL,		-- When the call was answered.  Null if the call was never answered.
	"endDateTime" TIMESTAMP NULL,		-- When the call ended.  Null if the call is still active or was never connected.
	"durationSeconds" INT NULL,		-- The duration of the call in seconds.  Calculated from answerDateTime to endDateTime.
	"objectGuid" VARCHAR(50) NOT NULL UNIQUE,		-- Unique identifier for this table.
	"active" BOOLEAN NOT NULL DEFAULT true,		-- Active from a business perspective flag.
	"deleted" BOOLEAN NOT NULL DEFAULT false,		-- Soft deletion flag.
	CONSTRAINT "callTypeId" FOREIGN KEY ("callTypeId") REFERENCES "Scheduler"."CallType"("id"),		-- Foreign key to the CallType table.
	CONSTRAINT "callStatusId" FOREIGN KEY ("callStatusId") REFERENCES "Scheduler"."CallStatus"("id"),		-- Foreign key to the CallStatus table.
	CONSTRAINT "conversationId" FOREIGN KEY ("conversationId") REFERENCES "Scheduler"."Conversation"("id")		-- Foreign key to the Conversation table.
);
...
(
	...
	"joinedDateTime" TIMESTAMP NULL,		-- When the participant joined the call.  Null if they never joined.
	"leftDateTime" TIMESTAMP NULL,		-- When the participant left the call.  Null if they are still in the call or never joined.
	"objectGuid" VARCHAR(50) NOT NULL UNIQUE,		-- Unique identifier for this table.
	"active" BOOLEAN NOT NULL DEFAULT true,		-- Active from a business perspective flag.
	"deleted" BOOLEAN NOT NULL DEFAULT false,		-- Soft deletion flag.
	CONSTRAINT "callId" FOREIGN KEY ("callId") REFERENCES "Scheduler"."Call"("id")		-- Foreign key to the Call table.
);
...
(
	...
	"dateTimeCreated" TIMESTAMP NOT NULL,		-- When the event occurred.
	"objectGuid" VARCHAR(50) NOT NULL UNIQUE,		-- Unique identifier for this table.
	"active" BOOLEAN NOT NULL DEFAULT true,		-- Active from a business perspective flag.
	"deleted" BOOLEAN NOT NULL DEFAULT false,		-- Soft deletion flag.
	CONSTRAINT "callId" FOREIGN KEY ("callId") REFERENCES "Scheduler"."Call"("id")		-- Foreign key to the Call table.
...
(
	...
	CONSTRAINT "resourceId" FOREIGN KEY ("resourceId") REFERENCES "Scheduler"."Resource"("id"),		-- Foreign key to the Resource table.
	CONSTRAINT "contactId" FOREIGN KEY ("contactId") REFERENCES "Scheduler"."Contact"("id"),		-- Foreign key to the Contact table.
	CONSTRAINT "eventNotificationTypeId" FOREIGN KEY ("eventNotificationTypeId") REFERENCES "Scheduler"."EventNotificationType"("id")		-- Foreign key to the EventNotificationType table.
);
...
CREATE INDEX "I_EventNotificationSubscription_tenantGuid_eventNotificationTyp" ON "Scheduler"."EventNotificationSubscription" ("tenantGuid", "eventNotificationTypeId")
;
...
(
	...
	"userId" INT NOT NULL,
	"data" TEXT NOT NULL,		-- This stores the JSON representing the object's historical state.
	CONSTRAINT "eventNotificationSubscriptionId" FOREIGN KEY ("eventNotificationSubscriptionId") REFERENCES "Scheduler"."EventNotificationSubscription"("id")		-- Foreign key to the EventNotificationSubscription table.
);
...
CREATE INDEX "I_EventNotificationSubscriptionChangeHistory_tenantGuid_version" ON "Scheduler"."EventNotificationSubscriptionChangeHistory" ("tenantGuid", "versionNumber")
;

-- Index on the EventNotificationSubscriptionChangeHistory table's tenantGuid,timeStamp fields.
CREATE INDEX "I_EventNotificationSubscriptionChangeHistory_tenantGuid_timeSta" ON "Scheduler"."EventNotificationSubscriptionChangeHistory" ("tenantGuid", "timeStamp")
;
...
CREATE INDEX "I_EventNotificationSubscriptionChangeHistory_tenantGuid_eventNo" ON "Scheduler"."EventNotificationSubscriptionChangeHistory" ("tenantGuid", "eventNotificationSubscriptionId") INCLUDE ( versionNumber, timeStamp, userId )
;
