...
INSERT INTO "Security"."SecurityRole" ( "name", "description", "privilegeId" ) VALUES  ( 'Scheduler Financial Manager', 'Scheduler Financial Manager Role', ( SELECT id FROM "Privilege" WHERE "name" = 'Custom' LIMIT 1) );

INSERT INTO "Security"."SecurityRole" ( "name", "description", "privilegeId" ) VALUES  ( 'Scheduler Fundraising Manager', 'Scheduler Fundraising Manager Role', ( SELECT id FROM "Privilege" WHERE "name" = 'Custom' LIMIT 1) );

INSERT INTO "Security"."SecurityRole" ( "name", "description", "privilegeId" ) VALUES  ( 'Scheduler Volunteer Manager', 'Scheduler Volunteer Manager Role', ( SELECT id FROM "Privilege" WHERE "name" = 'Custom' LIMIT 1) );

INSERT INTO "Security"."SecurityRole" ( "name", "description", "privilegeId" ) VALUES  ( 'Scheduler Messaging Manager', 'Scheduler Messaging Manager Role', ( SELECT id FROM "Privilege" WHERE "name" = 'Custom' LIMIT 1) );
...
INSERT INTO "Security"."ModuleSecurityRole" ( "moduleId", "securityRoleId" ) VALUES  ( ( SELECT id FROM "Module" WHERE "name" = 'Scheduler' LIMIT 1), ( SELECT id FROM "SecurityRole" WHERE "name" = 'Scheduler Financial Manager' LIMIT 1) );

INSERT INTO "Security"."ModuleSecurityRole" ( "moduleId", "securityRoleId" ) VALUES  ( ( SELECT id FROM "Module" WHERE "name" = 'Scheduler' LIMIT 1), ( SELECT id FROM "SecurityRole" WHERE "name" = 'Scheduler Fundraising Manager' LIMIT 1) );

INSERT INTO "Security"."ModuleSecurityRole" ( "moduleId", "securityRoleId" ) VALUES  ( ( SELECT id FROM "Module" WHERE "name" = 'Scheduler' LIMIT 1), ( SELECT id FROM "SecurityRole" WHERE "name" = 'Scheduler Volunteer Manager' LIMIT 1) );

INSERT INTO "Security"."ModuleSecurityRole" ( "moduleId", "securityRoleId" ) VALUES  ( ( SELECT id FROM "Module" WHERE "name" = 'Scheduler' LIMIT 1), ( SELECT id FROM "SecurityRole" WHERE "name" = 'Scheduler Messaging Manager' LIMIT 1) );
