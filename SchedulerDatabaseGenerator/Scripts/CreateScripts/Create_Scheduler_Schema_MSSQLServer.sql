...
-- ALTER INDEX ALL ON [Scheduler].[SalesforceSyncQueue] DISABLE
-- ALTER INDEX ALL ON [Scheduler].[SalesforceTenantLinkChangeHistory] DISABLE
-- ALTER INDEX ALL ON [Scheduler].[SalesforceTenantLink] DISABLE
...
-- ALTER INDEX ALL ON [Scheduler].[DocumentShareLinkChangeHistory] DISABLE
-- ALTER INDEX ALL ON [Scheduler].[DocumentShareLink] DISABLE
...
-- ALTER INDEX ALL ON [Scheduler].[InvoiceChangeHistory] DISABLE
-- ALTER INDEX ALL ON [Scheduler].[Invoice] DISABLE
-- ALTER INDEX ALL ON [Scheduler].[InvoiceStatus] DISABLE
...
-- ALTER INDEX ALL ON [Scheduler].[FiscalPeriodChangeHistory] DISABLE
-- ALTER INDEX ALL ON [Scheduler].[FiscalPeriod] DISABLE
-- ALTER INDEX ALL ON [Scheduler].[PeriodStatus] DISABLE
-- ALTER INDEX ALL ON [Scheduler].[EventChargeChangeHistory] DISABLE
-- ALTER INDEX ALL ON [Scheduler].[EventCharge] DISABLE
-- ALTER INDEX ALL ON [Scheduler].[ChargeStatusChangeHistory] DISABLE
...
-- ALTER INDEX ALL ON [Scheduler].[EventTypeChangeHistory] DISABLE
-- ALTER INDEX ALL ON [Scheduler].[EventType] DISABLE
...
-- ALTER INDEX ALL ON [Scheduler].[ReceiptTypeChangeHistory] DISABLE
-- ALTER INDEX ALL ON [Scheduler].[ReceiptType] DISABLE
-- ALTER INDEX ALL ON [Scheduler].[PaymentTypeChangeHistory] DISABLE
...
-- ALTER INDEX ALL ON [Scheduler].[TaxCode] DISABLE
...
-- ALTER INDEX ALL ON [Scheduler].[FinancialOfficeChangeHistory] DISABLE
-- ALTER INDEX ALL ON [Scheduler].[FinancialOffice] DISABLE
-- ALTER INDEX ALL ON [Scheduler].[AccountType] DISABLE
...
-- ALTER INDEX ALL ON [Scheduler].[SalesforceSyncQueue] REBUILD
-- ALTER INDEX ALL ON [Scheduler].[SalesforceTenantLinkChangeHistory] REBUILD
-- ALTER INDEX ALL ON [Scheduler].[SalesforceTenantLink] REBUILD
...
-- ALTER INDEX ALL ON [Scheduler].[DocumentShareLinkChangeHistory] REBUILD
-- ALTER INDEX ALL ON [Scheduler].[DocumentShareLink] REBUILD
...
-- ALTER INDEX ALL ON [Scheduler].[InvoiceChangeHistory] REBUILD
-- ALTER INDEX ALL ON [Scheduler].[Invoice] REBUILD
-- ALTER INDEX ALL ON [Scheduler].[InvoiceStatus] REBUILD
...
-- ALTER INDEX ALL ON [Scheduler].[FiscalPeriodChangeHistory] REBUILD
-- ALTER INDEX ALL ON [Scheduler].[FiscalPeriod] REBUILD
-- ALTER INDEX ALL ON [Scheduler].[PeriodStatus] REBUILD
-- ALTER INDEX ALL ON [Scheduler].[EventChargeChangeHistory] REBUILD
-- ALTER INDEX ALL ON [Scheduler].[EventCharge] REBUILD
-- ALTER INDEX ALL ON [Scheduler].[ChargeStatusChangeHistory] REBUILD
...
-- ALTER INDEX ALL ON [Scheduler].[EventTypeChangeHistory] REBUILD
-- ALTER INDEX ALL ON [Scheduler].[EventType] REBUILD
...
-- ALTER INDEX ALL ON [Scheduler].[ReceiptTypeChangeHistory] REBUILD
-- ALTER INDEX ALL ON [Scheduler].[ReceiptType] REBUILD
-- ALTER INDEX ALL ON [Scheduler].[PaymentTypeChangeHistory] REBUILD
...
-- ALTER INDEX ALL ON [Scheduler].[TaxCode] REBUILD
...
-- ALTER INDEX ALL ON [Scheduler].[FinancialOfficeChangeHistory] REBUILD
-- ALTER INDEX ALL ON [Scheduler].[FinancialOffice] REBUILD
-- ALTER INDEX ALL ON [Scheduler].[AccountType] REBUILD
...
CREATE INDEX [I_ConversationMessage_tenantGuid_dateTimeCreated] ON [Scheduler].[ConversationMessage] ([tenantGuid], [dateTimeCreated])
GO
...
(
	...
	[externalMapping] NVARCHAR(100) NULL,		-- Maps to the account type in external systems (e.g., QuickBooks account type name).
	[color] NVARCHAR(10) NULL,		-- Hex color for UI display.
	[sequence] INT NULL,		-- Sequence to use for sorting.
	[objectGuid] UNIQUEIDENTIFIER NOT NULL UNIQUE,		-- Unique identifier for this table.
	[active] BIT NOT NULL DEFAULT 1,		-- Active from a business perspective flag.
...
INSERT INTO [Scheduler].[AccountType] ( [name], [description], [isRevenue], [externalMapping], [color], [sequence], [objectGuid] ) VALUES  ( 'Income', 'Revenue from operations, sales, services, grants, etc.', 1, 'Income', '#4CAF50', 1, 'a1b2c3d4-0001-4000-8000-000000000001' )
GO

INSERT INTO [Scheduler].[AccountType] ( [name], [description], [isRevenue], [externalMapping], [color], [sequence], [objectGuid] ) VALUES  ( 'Expense', 'Operating expenses, overhead, supplies, labour, etc.', 0, 'Expense', '#F44336', 2, 'a1b2c3d4-0001-4000-8000-000000000002' )
GO

INSERT INTO [Scheduler].[AccountType] ( [name], [description], [isRevenue], [externalMapping], [color], [sequence], [objectGuid] ) VALUES  ( 'COGS', 'Cost of Goods Sold — direct costs attributable to goods/services sold.', 0, 'Cost of Goods Sold', '#FF9800', 3, 'a1b2c3d4-0001-4000-8000-000000000003' )
GO

INSERT INTO [Scheduler].[AccountType] ( [name], [description], [isRevenue], [externalMapping], [color], [sequence], [objectGuid] ) VALUES  ( 'Asset', 'Resources owned — cash, equipment, accounts receivable, etc.', 0, 'Other Current Asset', '#2196F3', 4, 'a1b2c3d4-0001-4000-8000-000000000004' )
GO

INSERT INTO [Scheduler].[AccountType] ( [name], [description], [isRevenue], [externalMapping], [color], [sequence], [objectGuid] ) VALUES  ( 'Liability', 'Obligations owed — accounts payable, loans, deferred revenue, etc.', 0, 'Other Current Liability', '#9C27B0', 5, 'a1b2c3d4-0001-4000-8000-000000000005' )
GO

INSERT INTO [Scheduler].[AccountType] ( [name], [description], [isRevenue], [externalMapping], [color], [sequence], [objectGuid] ) VALUES  ( 'Equity', 'Owner''s equity, retained earnings, net assets.', 0, 'Equity', '#607D8B', 6, 'a1b2c3d4-0001-4000-8000-000000000006' )
GO
...
(
	...
	[name] NVARCHAR(100) NOT NULL,
	[description] NVARCHAR(500) NOT NULL,
	[code] NVARCHAR(50) NOT NULL,		-- Short code for the office (e.g., 'REC', 'ADMIN', 'FIRE').
	[contactName] NVARCHAR(250) NULL,		-- Accountant or financial contact name for this office.
	[contactEmail] NVARCHAR(250) NULL,		-- Accountant or financial contact email for export delivery.
	[exportFormat] NVARCHAR(50) NULL DEFAULT 'CSV',		-- Preferred export format: CSV, QuickBooks, Xero, etc.
	[color] NVARCHAR(10) NULL,		-- Hex color for UI display.
	[sequence] INT NULL,		-- Sequence to use for sorting.
	[versionNumber] INT NOT NULL DEFAULT 1,		-- The version number of this record.  Increased by one each time the record changes, and the change history is tracked in the table's change history table.
	[objectGuid] UNIQUEIDENTIFIER NOT NULL UNIQUE,		-- Unique identifier for this table.
...
(
	...
	CONSTRAINT [FK_FinancialOfficeChangeHistory_FinancialOffice_financialOfficeId] FOREIGN KEY ([financialOfficeId]) REFERENCES [Scheduler].[FinancialOffice] ([id])		-- Foreign key to the FinancialOffice table.
)
GO
...
(
	...
	[externalAccountId] NVARCHAR(250) NULL,		-- Account ID in external system (e.g., QuickBooks account ID) for sync.
	[sequence] INT NULL,		-- Sequence to use for sorting.
	[color] NVARCHAR(10) NULL,		-- Hex color for UI display.
	[versionNumber] INT NOT NULL DEFAULT 1,		-- The version number of this record.  Increased by one each time the record changes, and the change history is tracked in the table's change history table.
	[objectGuid] UNIQUEIDENTIFIER NOT NULL UNIQUE,		-- Unique identifier for this table.
	...
	CONSTRAINT [FK_FinancialCategory_AccountType_accountTypeId] FOREIGN KEY ([accountTypeId]) REFERENCES [Scheduler].[AccountType] ([id]),		-- Foreign key to the AccountType table.
	CONSTRAINT [FK_FinancialCategory_FinancialOffice_financialOfficeId] FOREIGN KEY ([financialOfficeId]) REFERENCES [Scheduler].[FinancialOffice] ([id]),		-- Foreign key to the FinancialOffice table.
...
(
	...
	[name] NVARCHAR(100) NOT NULL,
	[description] NVARCHAR(500) NOT NULL,
	[code] NVARCHAR(50) NOT NULL,		-- Short tax code identifier (e.g., 'HST', 'GST', 'EXEMPT').
	...
	[externalTaxCodeId] NVARCHAR(250) NULL,		-- Tax code ID in external system (e.g., QuickBooks TaxCode ID).
	[sequence] INT NULL,		-- Sequence to use for sorting.
	[objectGuid] UNIQUEIDENTIFIER NOT NULL UNIQUE,		-- Unique identifier for this table.
	[active] BIT NOT NULL DEFAULT 1,		-- Active from a business perspective flag.
	[deleted] BIT NOT NULL DEFAULT 0		-- Soft deletion flag.
...
(
	...
	CONSTRAINT [FK_ChargeType_FinancialCategory_financialCategoryId] FOREIGN KEY ([financialCategoryId]) REFERENCES [Scheduler].[FinancialCategory] ([id]),		-- Foreign key to the FinancialCategory table.
	CONSTRAINT [FK_ChargeType_TaxCode_taxCodeId] FOREIGN KEY ([taxCodeId]) REFERENCES [Scheduler].[TaxCode] ([id]),		-- Foreign key to the TaxCode table.
...
(
	...
	[invoiceNumberMask] NVARCHAR(100) NULL,		-- Format mask for auto-generating invoice numbers. Supports {YYYY} for year and {NNNN} for zero-padded sequence. Default: INV-{YYYY}-{NNNN}.
	[receiptNumberMask] NVARCHAR(100) NULL,		-- Format mask for auto-generating receipt numbers. Supports {YYYY} for year and {NNNN} for zero-padded sequence. Default: REC-{YYYY}-{NNNN}.
	[versionNumber] INT NOT NULL DEFAULT 1,		-- The version number of this record.  Increased by one each time the record changes, and the change history is tracked in the table's change history table.
	[objectGuid] UNIQUEIDENTIFIER NOT NULL UNIQUE,		-- Unique identifier for this table.
	[active] BIT NOT NULL DEFAULT 1,		-- Active from a business perspective flag.
	[deleted] BIT NOT NULL DEFAULT 0		-- Soft deletion flag.
...
(
	...
	CONSTRAINT [FK_PaymentTypeChangeHistory_PaymentType_paymentTypeId] FOREIGN KEY ([paymentTypeId]) REFERENCES [Scheduler].[PaymentType] ([id])		-- Foreign key to the PaymentType table.
)
GO
...
(
	...
	CONSTRAINT [FK_ReceiptTypeChangeHistory_ReceiptType_receiptTypeId] FOREIGN KEY ([receiptTypeId]) REFERENCES [Scheduler].[ReceiptType] ([id])		-- Foreign key to the ReceiptType table.
)
GO
...
(
	...
	[name] NVARCHAR(100) NOT NULL,
	[description] NVARCHAR(500) NOT NULL,
	[color] NVARCHAR(10) NULL,		-- Hex color for UI display and calendar event color-coding.
	[iconId] INT NULL,		-- Icon to use for UI display.
	[sequence] INT NULL,		-- Sequence to use for sorting.
	...
	[defaultPrice] MONEY NULL,		-- Default rental price for events of this type. Used to auto-populate charges in the booking flow.
	...
	CONSTRAINT [FK_EventType_Icon_iconId] FOREIGN KEY ([iconId]) REFERENCES [Scheduler].[Icon] ([id]),		-- Foreign key to the Icon table.
	CONSTRAINT [FK_EventType_ChargeType_chargeTypeId] FOREIGN KEY ([chargeTypeId]) REFERENCES [Scheduler].[ChargeType] ([id]),		-- Foreign key to the ChargeType table.
...
(
	...
	CONSTRAINT [FK_EventTypeChangeHistory_EventType_eventTypeId] FOREIGN KEY ([eventTypeId]) REFERENCES [Scheduler].[EventType] ([id])		-- Foreign key to the EventType table.
)
GO
...
(
	...
	CONSTRAINT [FK_ScheduledEvent_EventType_eventTypeId] FOREIGN KEY ([eventTypeId]) REFERENCES [Scheduler].[EventType] ([id]),		-- Foreign key to the EventType table.
...
(
	...
	CONSTRAINT [FK_ChargeStatusChangeHistory_ChargeStatus_chargeStatusId] FOREIGN KEY ([chargeStatusId]) REFERENCES [Scheduler].[ChargeStatus] ([id])		-- Foreign key to the ChargeStatus table.
)
GO
...
(
	...
	[extendedAmount] MONEY NOT NULL DEFAULT 0,		-- Pre-tax amount (quantity × unitPrice, or just amount for flat fees).
	[taxAmount] MONEY NOT NULL DEFAULT 0,		-- The calculated tax based on TaxCode.rate.
	[totalAmount] MONEY NOT NULL DEFAULT 0,		-- Total amount inclusive of tax (extendedAmount + taxAmount). Consistent with FinancialTransaction.totalAmount.
	[description] NVARCHAR(250) NULL,		-- Short description or label for the charge. Falls back to ChargeType.name if not set.
	...
	CONSTRAINT [FK_EventCharge_TaxCode_taxCodeId] FOREIGN KEY ([taxCodeId]) REFERENCES [Scheduler].[TaxCode] ([id])		-- Foreign key to the TaxCode table.
)
GO
...
(
	...
	[name] NVARCHAR(100) NOT NULL,
	[description] NVARCHAR(500) NOT NULL,
	[startDate] DATETIME2(7) NOT NULL,		-- Period start date (inclusive).
	[endDate] DATETIME2(7) NOT NULL,		-- Period end date (inclusive).
	[periodType] NVARCHAR(50) NOT NULL DEFAULT 'Month',		-- Period type: Month, Quarter, Year, Custom.
	...
	[closedDate] DATETIME2(7) NULL,		-- When the period was closed.
	[closedBy] NVARCHAR(100) NULL,		-- User who closed the period.
	[sequence] INT NULL,		-- Sequence to use for sorting.
	[versionNumber] INT NOT NULL DEFAULT 1,		-- The version number of this record.  Increased by one each time the record changes, and the change history is tracked in the table's change history table.
	[objectGuid] UNIQUEIDENTIFIER NOT NULL UNIQUE,		-- Unique identifier for this table.
	[active] BIT NOT NULL DEFAULT 1,		-- Active from a business perspective flag.
	...
	CONSTRAINT [FK_FiscalPeriod_PeriodStatus_periodStatusId] FOREIGN KEY ([periodStatusId]) REFERENCES [Scheduler].[PeriodStatus] ([id]),		-- Foreign key to the PeriodStatus table.
...
(
	...
	CONSTRAINT [FK_FiscalPeriodChangeHistory_FiscalPeriod_fiscalPeriodId] FOREIGN KEY ([fiscalPeriodId]) REFERENCES [Scheduler].[FiscalPeriod] ([id])		-- Foreign key to the FiscalPeriod table.
)
GO
...
(
	...
	[contactRole] NVARCHAR(50) NULL DEFAULT 'Customer',		-- Role of the linked contact: Customer, Vendor, Employee. Maps to QuickBooks entity types for sync.
	...
	[amount] MONEY NOT NULL DEFAULT 0,		-- Transaction amount before tax. Always positive — direction determined by FinancialCategory.accountType.
	[taxAmount] MONEY NOT NULL DEFAULT 0,		-- Tax amount (e.g., HST). Calculated from TaxCode.rate when applicable.
	...
	[journalEntryType] NVARCHAR(50) NULL,		-- Double-entry type for accounting integration: Debit or Credit. Null = auto-determined from isRevenue.
	...
	[externalId] NVARCHAR(100) NULL,		-- Identifier from external system (e.g., QuickBooks Transaction ID).
	[externalSystemName] NVARCHAR(50) NULL,		-- Name of the external system (e.g., 'QuickBooks', 'Xero') for multi-system tracking.
	[versionNumber] INT NOT NULL DEFAULT 1,		-- The version number of this record.  Increased by one each time the record changes, and the change history is tracked in the table's change history table.
	[objectGuid] UNIQUEIDENTIFIER NOT NULL UNIQUE,		-- Unique identifier for this table.
	[active] BIT NOT NULL DEFAULT 1,		-- Active from a business perspective flag.
	[deleted] BIT NOT NULL DEFAULT 0		-- Soft deletion flag.
	...
	CONSTRAINT [FK_FinancialTransaction_FinancialOffice_financialOfficeId] FOREIGN KEY ([financialOfficeId]) REFERENCES [Scheduler].[FinancialOffice] ([id]),		-- Foreign key to the FinancialOffice table.
	...
	CONSTRAINT [FK_FinancialTransaction_Client_clientId] FOREIGN KEY ([clientId]) REFERENCES [Scheduler].[Client] ([id]),		-- Foreign key to the Client table.
	CONSTRAINT [FK_FinancialTransaction_TaxCode_taxCodeId] FOREIGN KEY ([taxCodeId]) REFERENCES [Scheduler].[TaxCode] ([id]),		-- Foreign key to the TaxCode table.
	CONSTRAINT [FK_FinancialTransaction_FiscalPeriod_fiscalPeriodId] FOREIGN KEY ([fiscalPeriodId]) REFERENCES [Scheduler].[FiscalPeriod] ([id]),		-- Foreign key to the FiscalPeriod table.
	CONSTRAINT [FK_FinancialTransaction_PaymentType_paymentTypeId] FOREIGN KEY ([paymentTypeId]) REFERENCES [Scheduler].[PaymentType] ([id]),		-- Foreign key to the PaymentType table.
...
(
	...
	[budgetedAmount] MONEY NOT NULL DEFAULT 0,		-- The planned/budgeted amount for this category in this period.
	[revisedAmount] MONEY NULL,		-- Optional revised budget amount (after mid-period adjustments).
	[notes] NVARCHAR(MAX) NULL,		-- Optional notes about the budget line (e.g., justification for revision).
	[currencyId] INT NOT NULL,		-- Link to Currency table.
	[versionNumber] INT NOT NULL DEFAULT 1,		-- The version number of this record.  Increased by one each time the record changes, and the change history is tracked in the table's change history table.
	[objectGuid] UNIQUEIDENTIFIER NOT NULL UNIQUE,		-- Unique identifier for this table.
	[active] BIT NOT NULL DEFAULT 1,		-- Active from a business perspective flag.
	...
	CONSTRAINT [FK_Budget_FinancialCategory_financialCategoryId] FOREIGN KEY ([financialCategoryId]) REFERENCES [Scheduler].[FinancialCategory] ([id]),		-- Foreign key to the FinancialCategory table.
	CONSTRAINT [FK_Budget_FiscalPeriod_fiscalPeriodId] FOREIGN KEY ([fiscalPeriodId]) REFERENCES [Scheduler].[FiscalPeriod] ([id]),		-- Foreign key to the FiscalPeriod table.
	CONSTRAINT [FK_Budget_FinancialOffice_financialOfficeId] FOREIGN KEY ([financialOfficeId]) REFERENCES [Scheduler].[FinancialOffice] ([id]),		-- Foreign key to the FinancialOffice table.
	CONSTRAINT [FK_Budget_Currency_currencyId] FOREIGN KEY ([currencyId]) REFERENCES [Scheduler].[Currency] ([id]),		-- Foreign key to the Currency table.
...
(
	...
	CONSTRAINT [FK_BudgetChangeHistory_Budget_budgetId] FOREIGN KEY ([budgetId]) REFERENCES [Scheduler].[Budget] ([id])		-- Foreign key to the Budget table.
)
GO
...
(
	[id] INT IDENTITY PRIMARY KEY NOT NULL,
	[tenantGuid] UNIQUEIDENTIFIER NOT NULL,		-- The guid for the Tenant to which this record belongs.
	[invoiceNumber] NVARCHAR(50) NOT NULL,		-- Auto-generated sequential invoice number (e.g., 'INV-2025-0001').
	...
	[invoiceDate] DATETIME2(7) NOT NULL,		-- Date the invoice was issued (UTC).
	[dueDate] DATETIME2(7) NOT NULL,		-- Payment due date (UTC).
	[subtotal] MONEY NOT NULL DEFAULT 0,		-- Sum of line item amounts before tax.
	[taxAmount] MONEY NOT NULL DEFAULT 0,		-- Total tax amount.
	[totalAmount] MONEY NOT NULL DEFAULT 0,		-- Grand total (subtotal + taxAmount).
	[amountPaid] MONEY NOT NULL DEFAULT 0,		-- Running total of payments received against this invoice.
	[sentDate] DATETIME2(7) NULL,		-- When the invoice was sent to the client (null = not sent).
	[paidDate] DATETIME2(7) NULL,		-- When the invoice was fully paid (null = not yet paid).
	[notes] NVARCHAR(MAX) NULL,		-- Optional notes or payment terms.
	[versionNumber] INT NOT NULL DEFAULT 1,		-- The version number of this record.  Increased by one each time the record changes, and the change history is tracked in the table's change history table.
	[objectGuid] UNIQUEIDENTIFIER NOT NULL UNIQUE,		-- Unique identifier for this table.
	[active] BIT NOT NULL DEFAULT 1,		-- Active from a business perspective flag.
	[deleted] BIT NOT NULL DEFAULT 0		-- Soft deletion flag.

	CONSTRAINT [FK_Invoice_Client_clientId] FOREIGN KEY ([clientId]) REFERENCES [Scheduler].[Client] ([id]),		-- Foreign key to the Client table.
	CONSTRAINT [FK_Invoice_Contact_contactId] FOREIGN KEY ([contactId]) REFERENCES [Scheduler].[Contact] ([id]),		-- Foreign key to the Contact table.
	CONSTRAINT [FK_Invoice_ScheduledEvent_scheduledEventId] FOREIGN KEY ([scheduledEventId]) REFERENCES [Scheduler].[ScheduledEvent] ([id]),		-- Foreign key to the ScheduledEvent table.
	CONSTRAINT [FK_Invoice_FinancialOffice_financialOfficeId] FOREIGN KEY ([financialOfficeId]) REFERENCES [Scheduler].[FinancialOffice] ([id]),		-- Foreign key to the FinancialOffice table.
	CONSTRAINT [FK_Invoice_InvoiceStatus_invoiceStatusId] FOREIGN KEY ([invoiceStatusId]) REFERENCES [Scheduler].[InvoiceStatus] ([id]),		-- Foreign key to the InvoiceStatus table.
	CONSTRAINT [FK_Invoice_Currency_currencyId] FOREIGN KEY ([currencyId]) REFERENCES [Scheduler].[Currency] ([id]),		-- Foreign key to the Currency table.
	CONSTRAINT [FK_Invoice_TaxCode_taxCodeId] FOREIGN KEY ([taxCodeId]) REFERENCES [Scheduler].[TaxCode] ([id]),		-- Foreign key to the TaxCode table.
...
(
	...
	CONSTRAINT [FK_InvoiceChangeHistory_Invoice_invoiceId] FOREIGN KEY ([invoiceId]) REFERENCES [Scheduler].[Invoice] ([id])		-- Foreign key to the Invoice table.
)
GO
...
(
	...
	[description] NVARCHAR(500) NOT NULL,		-- Line item description (e.g., 'Hall Rental - Saturday Dec 14').
	[quantity] NUMERIC(38,22) NOT NULL DEFAULT 1,		-- Quantity (hours, units, etc.).
	[unitPrice] MONEY NOT NULL DEFAULT 0,		-- Price per unit.
	[amount] MONEY NOT NULL DEFAULT 0,		-- Extended amount (quantity × unitPrice).
	[taxAmount] MONEY NOT NULL DEFAULT 0,		-- Tax for this line item.
	[totalAmount] MONEY NOT NULL DEFAULT 0,		-- Line total (amount + taxAmount).
	[sequence] INT NULL,		-- Display order on the invoice.
	[objectGuid] UNIQUEIDENTIFIER NOT NULL UNIQUE,		-- Unique identifier for this table.
	[active] BIT NOT NULL DEFAULT 1,		-- Active from a business perspective flag.
	[deleted] BIT NOT NULL DEFAULT 0		-- Soft deletion flag.

	CONSTRAINT [FK_InvoiceLineItem_Invoice_invoiceId] FOREIGN KEY ([invoiceId]) REFERENCES [Scheduler].[Invoice] ([id]),		-- Foreign key to the Invoice table.
	CONSTRAINT [FK_InvoiceLineItem_EventCharge_eventChargeId] FOREIGN KEY ([eventChargeId]) REFERENCES [Scheduler].[EventCharge] ([id]),		-- Foreign key to the EventCharge table.
	CONSTRAINT [FK_InvoiceLineItem_FinancialCategory_financialCategoryId] FOREIGN KEY ([financialCategoryId]) REFERENCES [Scheduler].[FinancialCategory] ([id])		-- Foreign key to the FinancialCategory table.
)
GO
...
(
	[id] INT IDENTITY PRIMARY KEY NOT NULL,
	[tenantGuid] UNIQUEIDENTIFIER NOT NULL,		-- The guid for the Tenant to which this record belongs.
	[receiptNumber] NVARCHAR(50) NOT NULL,		-- Auto-generated sequential receipt number (e.g., 'REC-2025-0001').
	...
	[receiptDate] DATETIME2(7) NOT NULL,		-- Date the receipt was issued (UTC).
	[amount] MONEY NOT NULL DEFAULT 0,		-- Amount received.
	[paymentMethod] NVARCHAR(100) NULL,		-- How the payment was made (e.g., 'E-Transfer', 'Cash').
	[description] NVARCHAR(500) NULL,		-- Description of what the payment was for.
	[notes] NVARCHAR(MAX) NULL,		-- Optional additional notes.
	[versionNumber] INT NOT NULL DEFAULT 1,		-- The version number of this record.  Increased by one each time the record changes, and the change history is tracked in the table's change history table.
	[objectGuid] UNIQUEIDENTIFIER NOT NULL UNIQUE,		-- Unique identifier for this table.
	[active] BIT NOT NULL DEFAULT 1,		-- Active from a business perspective flag.
	[deleted] BIT NOT NULL DEFAULT 0		-- Soft deletion flag.

	CONSTRAINT [FK_Receipt_ReceiptType_receiptTypeId] FOREIGN KEY ([receiptTypeId]) REFERENCES [Scheduler].[ReceiptType] ([id]),		-- Foreign key to the ReceiptType table.
	CONSTRAINT [FK_Receipt_Invoice_invoiceId] FOREIGN KEY ([invoiceId]) REFERENCES [Scheduler].[Invoice] ([id]),		-- Foreign key to the Invoice table.
	CONSTRAINT [FK_Receipt_PaymentTransaction_paymentTransactionId] FOREIGN KEY ([paymentTransactionId]) REFERENCES [Scheduler].[PaymentTransaction] ([id]),		-- Foreign key to the PaymentTransaction table.
	CONSTRAINT [FK_Receipt_FinancialTransaction_financialTransactionId] FOREIGN KEY ([financialTransactionId]) REFERENCES [Scheduler].[FinancialTransaction] ([id]),		-- Foreign key to the FinancialTransaction table.
	CONSTRAINT [FK_Receipt_Client_clientId] FOREIGN KEY ([clientId]) REFERENCES [Scheduler].[Client] ([id]),		-- Foreign key to the Client table.
	CONSTRAINT [FK_Receipt_Contact_contactId] FOREIGN KEY ([contactId]) REFERENCES [Scheduler].[Contact] ([id]),		-- Foreign key to the Contact table.
	CONSTRAINT [FK_Receipt_Currency_currencyId] FOREIGN KEY ([currencyId]) REFERENCES [Scheduler].[Currency] ([id]),		-- Foreign key to the Currency table.
...
(
	...
	CONSTRAINT [FK_ReceiptChangeHistory_Receipt_receiptId] FOREIGN KEY ([receiptId]) REFERENCES [Scheduler].[Receipt] ([id])		-- Foreign key to the Receipt table.
)
GO
...
(
	...
	[linkedUserGuid] UNIQUEIDENTIFIER NULL,		-- Security user GUID for self-service Hub access
	[versionNumber] INT NOT NULL DEFAULT 1,		-- The version number of this record.  Increased by one each time the record changes, and the change history is tracked in the table's change history table.
	[objectGuid] UNIQUEIDENTIFIER NOT NULL UNIQUE,		-- Unique identifier for this table.
	[active] BIT NOT NULL DEFAULT 1,		-- Active from a business perspective flag.
	[deleted] BIT NOT NULL DEFAULT 0		-- Soft deletion flag.
...
(
	...
	[token] UNIQUEIDENTIFIER NOT NULL,		-- Public-facing GUID token used in the share URL. Separate from objectGuid.
	[passwordHash] NVARCHAR(250) NULL,		-- Optional bcrypt hash of the password required to access the download.
	[expiresAt] DATETIME2(7) NULL,		-- Optional expiry date (UTC). NULL = never expires.
	...
	[createdBy] NVARCHAR(250) NOT NULL,		-- User who created the share link.
	[createdDate] DATETIME2(7) NOT NULL,		-- When the share link was created (UTC).
	[versionNumber] INT NOT NULL DEFAULT 1,		-- The version number of this record.  Increased by one each time the record changes, and the change history is tracked in the table's change history table.
	[objectGuid] UNIQUEIDENTIFIER NOT NULL UNIQUE,		-- Unique identifier for this table.
	[active] BIT NOT NULL DEFAULT 1,		-- Active from a business perspective flag.
	[deleted] BIT NOT NULL DEFAULT 0		-- Soft deletion flag.

	CONSTRAINT [FK_DocumentShareLink_Document_documentId] FOREIGN KEY ([documentId]) REFERENCES [Scheduler].[Document] ([id])		-- Foreign key to the Document table.
)
GO
...
(
	...
	CONSTRAINT [FK_DocumentShareLinkChangeHistory_DocumentShareLink_documentShareLinkId] FOREIGN KEY ([documentShareLinkId]) REFERENCES [Scheduler].[DocumentShareLink] ([id])		-- Foreign key to the DocumentShareLink table.
)
GO
...
(
	...
	[sfPassword] NVARCHAR(500) NULL,		-- Salesforce API user password (should be encrypted at rest)
	[sfSecurityToken] NVARCHAR(250) NULL,		-- Salesforce security token appended to password for OAuth
	[instanceUrl] NVARCHAR(250) NULL,		-- Salesforce instance URL returned after successful OAuth (e.g. https://na1.salesforce.com)
	[apiVersion] NVARCHAR(50) NULL,		-- Salesforce REST API version (e.g. v56.0)
	[versionNumber] INT NOT NULL DEFAULT 1,		-- The version number of this record.  Increased by one each time the record changes, and the change history is tracked in the table's change history table.
	[objectGuid] UNIQUEIDENTIFIER NOT NULL UNIQUE,		-- Unique identifier for this table.
	[active] BIT NOT NULL DEFAULT 1,		-- Active from a business perspective flag.
	[deleted] BIT NOT NULL DEFAULT 0		-- Soft deletion flag.
...
(
	...
	CONSTRAINT [FK_SalesforceTenantLinkChangeHistory_SalesforceTenantLink_salesforceTenantLinkId] FOREIGN KEY ([salesforceTenantLinkId]) REFERENCES [Scheduler].[SalesforceTenantLink] ([id])		-- Foreign key to the SalesforceTenantLink table.
)
GO
...
CREATE INDEX [I_SalesforceTenantLinkChangeHistory_tenantGuid_salesforceTenantLinkId] ON [Scheduler].[SalesforceTenantLinkChangeHistory] ([tenantGuid], [salesforceTenantLinkId]) INCLUDE ( versionNumber, timeStamp, userId )
GO
...
(
	[id] INT IDENTITY PRIMARY KEY NOT NULL,
	[tenantGuid] UNIQUEIDENTIFIER NOT NULL,		-- The guid for the Tenant to which this record belongs.
	[entityType] NVARCHAR(100) NOT NULL,		-- The Scheduler entity type: Client, Contact, or ScheduledEvent
	[operationType] NVARCHAR(50) NOT NULL,		-- Create, Update, or Delete
	[entityId] INT NOT NULL,		-- Primary key of the Scheduler entity being synced
	[payload] NVARCHAR(MAX) NULL,		-- Optional JSON payload (e.g. salesforceId for delete operations)
	[status] NVARCHAR(50) NOT NULL,		-- Pending, InProgress, Completed, Failed, or Abandoned
	...
	[lastAttemptDate] DATETIME2(7) NULL,		-- UTC timestamp of the last processing attempt
	[completedDate] DATETIME2(7) NULL,		-- UTC timestamp when the item was successfully processed
	[createdDate] DATETIME2(7) NULL,		-- UTC timestamp when the item was enqueued
	[errorMessage] NVARCHAR(MAX) NULL,		-- Error message from the last failed attempt
	[responseBody] NVARCHAR(MAX) NULL,		-- Response body from the Salesforce API (for debugging)
	[objectGuid] UNIQUEIDENTIFIER NOT NULL UNIQUE,		-- Unique identifier for this table.
	[active] BIT NOT NULL DEFAULT 1,		-- Active from a business perspective flag.
	[deleted] BIT NOT NULL DEFAULT 0		-- Soft deletion flag.
