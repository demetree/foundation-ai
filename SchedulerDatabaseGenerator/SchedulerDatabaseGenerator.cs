...
while carrying volunteer-specific metadata, hours tracking, preferences, etc.";
            ...
            volunteerProfileTable.AddDateField("onboardedDate", true, true).AddScriptComments("Date volunteer was approved/onboarded");
            volunteerProfileTable.AddDateField("inactiveSince", true, true).AddScriptComments("If inactive, when they went inactive");
            volunteerProfileTable.AddSingleField("totalHoursServed", true, 0).AddScriptComments("Cached/rolled-up lifetime volunteer hours");
            volunteerProfileTable.AddDateField("lastActivityDate", true, true).AddScriptComments("Most recent event/assignment end date");
            volunteerProfileTable.AddBoolField("backgroundCheckCompleted", false, false);
            volunteerProfileTable.AddDateField("backgroundCheckDate", true, true);
            volunteerProfileTable.AddDateField("backgroundCheckExpiry", true, true);
            volunteerProfileTable.AddBoolField("confidentialityAgreementSigned", false, false);
            volunteerProfileTable.AddDateField("confidentialityAgreementDate", true, true);
...
Links Resources (volunteers) to groups, with optional default role and sequence.";
            ...
            volunteerGroupMemberTable.AddDateField("joinedDate", true, true);
            volunteerGroupMemberTable.AddDateField("leftDate", true, true).AddScriptComments("If they left the group");
