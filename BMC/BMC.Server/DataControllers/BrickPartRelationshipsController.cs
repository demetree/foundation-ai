			...
			CancellationToken cancellationToken = default)
		{
			...
			if (!string.IsNullOrEmpty(anyStringContains))
			{
			   query = query.Where(x =>
			       ...
			       || (includeRelations == true && x.childBrickPart.rebrickablePartUrl.Contains(anyStringContains))
			       || (includeRelations == true && x.childBrickPart.rebrickableImgUrl.Contains(anyStringContains))
			       || (includeRelations == true && x.childBrickPart.ldrawPartId.Contains(anyStringContains))
			       || (includeRelations == true && x.childBrickPart.bricklinkId.Contains(anyStringContains))
			       || (includeRelations == true && x.childBrickPart.brickowlId.Contains(anyStringContains))
			       || (includeRelations == true && x.childBrickPart.legoDesignId.Contains(anyStringContains))
			       ...
			       || (includeRelations == true && x.childBrickPart.materialType.Contains(anyStringContains))
			       || (includeRelations == true && x.childBrickPart.geometryFileName.Contains(anyStringContains))
			       || (includeRelations == true && x.childBrickPart.geometryMimeType.Contains(anyStringContains))
			       || (includeRelations == true && x.childBrickPart.geometryFileFormat.Contains(anyStringContains))
			       || (includeRelations == true && x.childBrickPart.geometryOriginalFileName.Contains(anyStringContains))
			...
			CancellationToken cancellationToken = default)
		{
			...
			if (!string.IsNullOrEmpty(anyStringContains))
			{
			   query = query.Where(x =>
			       ...
			       || x.childBrickPart.rebrickablePartUrl.Contains(anyStringContains)
			       || x.childBrickPart.rebrickableImgUrl.Contains(anyStringContains)
			       || x.childBrickPart.ldrawPartId.Contains(anyStringContains)
			       || x.childBrickPart.bricklinkId.Contains(anyStringContains)
			       || x.childBrickPart.brickowlId.Contains(anyStringContains)
			       || x.childBrickPart.legoDesignId.Contains(anyStringContains)
			       ...
			       || x.childBrickPart.materialType.Contains(anyStringContains)
			       || x.childBrickPart.geometryFileName.Contains(anyStringContains)
			       || x.childBrickPart.geometryMimeType.Contains(anyStringContains)
			       || x.childBrickPart.geometryFileFormat.Contains(anyStringContains)
			       || x.childBrickPart.geometryOriginalFileName.Contains(anyStringContains)
