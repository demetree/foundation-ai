...
namespace Foundation.BMC.Controllers.WebAPI
{
	...
	public partial class UserCollectionPartsController : SecureWebAPIController
	{
			...
			CancellationToken cancellationToken = default)
		{
			...
			//
			// Add the any string contains parameter to span all the string fields on the User Collection Part, or on an any of the string fields on its immediate relations
			//
