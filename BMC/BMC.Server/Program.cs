    ...
    public class Program
    {
        ...
        private static async Task Main(string[] args)
        {
            ...
            try
            {
                ...
                controllers.Add(typeof(BrickEconomyTransactionsController));
                controllers.Add(typeof(BrickEconomyUserLinksController));
                controllers.Add(typeof(BrickElementsController));
                controllers.Add(typeof(BrickLinkTransactionsController));
                controllers.Add(typeof(BrickLinkUserLinksController));
                controllers.Add(typeof(BrickOwlTransactionsController));
                controllers.Add(typeof(BrickOwlUserLinksController));
                ...
                controllers.Add(typeof(SubmodelInstancesController));
