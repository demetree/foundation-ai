...
export class BrickPartTableComponent implements OnInit, OnChanges, AfterViewInit {
 ...
 /**
  ...
  private buildDefaultColumns(): void {
    ...
    { key: 'rebrickablePartUrl', label: 'Rebrickable Part Url', width: undefined },
    { key: 'rebrickableImgUrl', label: 'Rebrickable Img Url', width: undefined },
    { key: 'ldrawPartId', label: 'Ldraw Part Id', width: undefined },
    { key: 'bricklinkId', label: 'Bricklink Id', width: undefined },
    { key: 'brickowlId', label: 'Brickowl Id', width: undefined },
    { key: 'legoDesignId', label: 'Lego Design Id', width: undefined },
    ...
    { key: 'momentOfInertiaX', label: 'Moment Of Inertia X', width: undefined },
    { key: 'momentOfInertiaY', label: 'Moment Of Inertia Y', width: undefined },
    { key: 'momentOfInertiaZ', label: 'Moment Of Inertia Z', width: undefined },
    { key: 'frictionCoefficient', label: 'Friction Coefficient', width: undefined },
    { key: 'materialType', label: 'Material Type', width: undefined },
    { key: 'centerOfMassX', label: 'Center Of Mass X', width: undefined },
    { key: 'centerOfMassY', label: 'Center Of Mass Y', width: undefined },
    { key: 'centerOfMassZ', label: 'Center Of Mass Z', width: undefined },
    // { key: 'geometryFileName', label: 'Geometry File Name', width: undefined },
    // { key: 'geometrySize', label: 'Geometry Size', width: undefined },
    // { key: 'geometryData', label: 'Geometry Data', width: undefined },
    // { key: 'geometryMimeType', label: 'Geometry Mime Type', width: undefined },
    { key: 'geometryFileFormat', label: 'Geometry File Format', width: undefined },
    { key: 'geometryOriginalFileName', label: 'Geometry Original File Name', width: undefined },
    { key: 'boundingBoxMinX', label: 'Bounding Box Min X', width: undefined },
    { key: 'boundingBoxMinY', label: 'Bounding Box Min Y', width: undefined },
    { key: 'boundingBoxMinZ', label: 'Bounding Box Min Z', width: undefined },
    { key: 'boundingBoxMaxX', label: 'Bounding Box Max X', width: undefined },
    { key: 'boundingBoxMaxY', label: 'Bounding Box Max Y', width: undefined },
    { key: 'boundingBoxMaxZ', label: 'Bounding Box Max Z', width: undefined },
    { key: 'subFileCount', label: 'Sub File Count', width: undefined },
    { key: 'polygonCount', label: 'Polygon Count', width: undefined },
