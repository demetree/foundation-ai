...
interface BuildManualStepFormValues {
  ...
  calloutNestingDepth: string | null,     // Stored as string for form input, converted to number on submit.
  calloutInstanceCount: string | null,     // Stored as string for form input, converted to number on submit.
...
export class BuildManualStepAddEditComponent {
  ...
  submitForm() {
    ...
    const buildManualStepSubmitData: BuildManualStepSubmitData = {
        ...
        calloutNestingDepth: formValue.calloutNestingDepth ? Number(formValue.calloutNestingDepth) : null,
        calloutInstanceCount: formValue.calloutInstanceCount ? Number(formValue.calloutInstanceCount) : null,
  ...
  private buildFormValues(buildManualStepData: BuildManualStepData | null) {
    ...
    if (buildManualStepData == null) {
      ...
      this.buildManualStepForm.reset({
        ...
        calloutNestingDepth: buildManualStepData.calloutNestingDepth?.toString() ?? '',
        calloutInstanceCount: buildManualStepData.calloutInstanceCount?.toString() ?? '',
