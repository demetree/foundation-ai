...
- [x] Similar Sets recommendation engine (Set Detail)
  - [x] Add scoring logic in set-detail.component.ts
  - [x] Add similar sets card grid in HTML + SCSS
- [x] Set comparison feature (compare up to 4 sets)
  - [x] Create SetComparisonService (singleton, sessionStorage)
  - [x] Add compare buttons to set-detail and set-explorer
  - [x] Create set-comparison component + route
- [x] Set Timeline / history view
  - [x] Add D3 scatter chart to theme-detail
  - [x] Add timeline chart styles

## Phase 4: Collection Integration
- [x] Create SetOwnershipCacheService (singleton, O(1) lookups)
- [x] Own/Want toggle on Set Detail heroes
- [x] Owned/Wanted badges on Set Explorer cards + table rows
- [x] Collection stats card on Universe dashboard
- [x] Theme completion % metric on Theme Detail
