...
## Phase 5: Filter Engine
- [ ] Implement recursive-descent filter parser
- [ ] Implement filter AST nodes (Comparison, And, Or, Not)
- [ ] Implement filter evaluator against Document
- [ ] Wire into Query path (filtered vector search)

## Phase 6: HNSW Index
- [ ] Implement multi-layer navigable graph structure
- [ ] Implement greedy beam search
- [ ] Implement concurrent insert with level assignment
