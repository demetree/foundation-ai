...
/* This function is expected to be overridden in a custom file
		...
		public async Task<IActionResult> PutPageChangeHistory(int id, [FromBody]Database.PageChangeHistory.PageChangeHistoryDTO pageChangeHistoryDTO, CancellationToken cancellationToken = default)
		{
			...
			//
			// The tenant guid for any PageChangeHistory being saved must match the tenant guid of the user.  
			//
			...
			{
				// Assign the tenantGuid to the PageChangeHistory because it shouldn't be on the input object, and we want to ensure that it always is what the correct value in case it is.
				pageChangeHistory.tenantGuid = existing.tenantGuid;
			}
