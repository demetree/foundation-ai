...
namespace Foundation.Scheduler.Database
{
	...
	public partial class AssignmentRoleQualificationRequirementChangeHistory : IChangeHistoryEntity, IAnonymousConvertible
	{
		...
		/// <summary>
		///
		/// Converts a AssignmentRoleQualificationRequirementChangeHistory to an OUTPUT Data Transfer Object.  This is the format to be used when serializing data to send back to client requests with nav properties to avoid using the AssignmentRoleQualificationRequirementChangeHistory Entity type directly.
		///
		/// </summary>
