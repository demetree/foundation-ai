...
namespace Foundation.Scheduler.Database
{
	...
	public partial class Contact : IVersionTrackedEntity<Contact>, IAnonymousConvertible
	{
		...
		/// <summary>
		///
		/// Converts a Contact to an OUTPUT Data Transfer Object.  This is the format to be used when serializing data to send back to client requests with nav properties to avoid using the ContactEntity type directly.
		///
		/// </summary>
