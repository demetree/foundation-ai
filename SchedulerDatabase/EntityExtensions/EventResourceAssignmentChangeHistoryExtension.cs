...
namespace Foundation.Scheduler.Database
{
	...
	public partial class EventResourceAssignmentChangeHistory : IChangeHistoryEntity, IAnonymousConvertible
	{
		...
		/// <summary>
		///
		/// Converts a EventResourceAssignmentChangeHistory to an OUTPUT Data Transfer Object.  This is the format to be used when serializing data to send back to client requests with nav properties to avoid using the EventResourceAssignmentChangeHistoryEntity type directly.
		///
		/// </summary>
