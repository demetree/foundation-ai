...
namespace Foundation.Scheduler.Database
{
	...
	public partial class Document : IVersionTrackedEntity<Document>, IAnonymousConvertible
	{
		...
		/// <summary>
		///
		/// Converts a Document to an OUTPUT Data Transfer Object.  This is the format to be used when serializing data to send back to client requests with nav properties to avoid using the DocumentEntity type directly.
		///
		/// </summary>
