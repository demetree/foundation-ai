...
namespace Foundation.Scheduler.Database
{
	...
	public partial class RecurrenceRule : IVersionTrackedEntity<RecurrenceRule>, IAnonymousConvertible
	{
		...
		/// <summary>
		///
		/// Converts a RecurrenceRule to an OUTPUT Data Transfer Object.  This is the format to be used when serializing data to send back to client requests with nav properties to avoid using the RecurrenceRuleEntity type directly.
		///
		/// </summary>
