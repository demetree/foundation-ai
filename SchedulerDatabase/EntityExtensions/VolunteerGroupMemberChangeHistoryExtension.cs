...
namespace Foundation.Scheduler.Database
{
	...
	public partial class VolunteerGroupMemberChangeHistory : IChangeHistoryEntity, IAnonymousConvertible
	{
		...
		/// <summary>
		///
		/// Converts a VolunteerGroupMemberChangeHistory to an OUTPUT Data Transfer Object.  This is the format to be used when serializing data to send back to client requests with nav properties to avoid using the VolunteerGroupMemberChangeHistory Entity type directly.
		///
		/// </summary>
