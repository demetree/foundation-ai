...
namespace Foundation.Scheduler.Database
{
	...
	//
	public partial class ReceiptType : IVersionTrackedEntity<ReceiptType>, IAnonymousConvertible
	{
        /// <summary>
        ...
        public static ChangeHistoryToolset<ReceiptType, ReceiptTypeChangeHistory> GetChangeHistoryToolsetForWriting(SchedulerContext context, Foundation.Security.Database.SecurityUser securityUser, bool insideTransaction = false, CancellationToken cancellationToken = default)
        {
            if (context == null)
            {
            ...
            // 
            return new ChangeHistoryToolset<ReceiptType, ReceiptTypeChangeHistory>(context, securityUser.id, insideTransaction, cancellationToken);
        }
        ...
        /// <exception cref="ArgumentNullException"></exception>
        /// <exception cref="Exception"></exception>
        public static Task<ChangeHistoryToolset<ReceiptType, ReceiptTypeChangeHistory>> GetChangeHistoryToolsetForWritingAsync(SchedulerContext context, Foundation.Security.Database.SecurityUser securityUser, bool insideTransaction = false, CancellationToken cancellationToken = default)
        {
            if (context == null)
            {
                throw new ArgumentNullException(nameof(context));
            ...
            // 
            return Task.FromResult(new ChangeHistoryToolset<ReceiptType, ReceiptTypeChangeHistory>(context, securityUser.id, insideTransaction, cancellationToken));
        }
        ...
        /// <exception cref="ArgumentNullException"></exception>
        /// <exception cref="Exception"></exception>
        public static ChangeHistoryToolset<ReceiptType, ReceiptTypeChangeHistory> GetChangeHistoryToolsetForReading(SchedulerContext context, CancellationToken cancellationToken = default)
        {
            return new ChangeHistoryToolset<ReceiptType, ReceiptTypeChangeHistory>(context, cancellationToken);
        }
        ...
        /// <returns></returns>
        /// <exception cref="Exception"></exception>
        public async Task<VersionInformation<ReceiptType>> GetThisVersionAsync(bool includeData = false, CancellationToken cancellationToken = default)
        {
        ...
        /// <returns></returns>
        /// <exception cref="Exception"></exception>
        public async Task<VersionInformation<ReceiptType>> GetFirstVersionAsync(bool includeData = true, CancellationToken cancellationToken = default)
        {
        ...
        /// <returns></returns>
        /// <exception cref="Exception"></exception>
        public async Task<VersionInformation<ReceiptType>> GetVersionAtTimeAsync(DateTime pointInTime, bool includeData = true, CancellationToken cancellationToken = default)
        {
            ...
            {
                throw new Exception($"No change history found for point in time {pointInTime.ToString("s")} of this ReceiptType entity.");
            }

            VersionInformation<ReceiptType> version = new VersionInformation<ReceiptType>();
        ...
        /// <returns></returns>
        /// <exception cref="Exception"></exception>
        public async Task<VersionInformation<ReceiptType>> GetVersionAsync(int versionNumber, bool includeData = true, CancellationToken cancellationToken = default)
        {
            if (_contextForVersionInquiry == null || _tenantGuidForVersionInquiry == Guid.Empty)
            {
            ...
            if (versionAudit == null)
            {
                throw new Exception($"No change history found for version {versionNumber} of this ReceiptType entity.");
            }
        ...
        /// <returns></returns>
        /// <exception cref="Exception"></exception>
        public async Task<List<VersionInformation<ReceiptType>>> GetAllVersionsAsync(bool includeData = true, CancellationToken cancellationToken = default)
        {
            if (_contextForVersionInquiry == null || _tenantGuidForVersionInquiry == Guid.Empty)
            {
            ...
            List <VersionInformation<ReceiptType>> versions = new List<VersionInformation<ReceiptType>>();
		...
		/// <summary>
		///
		/// Converts a ReceiptType to an OUTPUT Data Transfer Object.  This is the format to be used when serializing data to send back to client requests with nav properties to avoid using the ReceiptType Entity type directly.
		///
		/// </summary>
		...
		public static object CreateAnonymous(Database.ReceiptType receiptType)
		{
			...
			return new {
				...
				color = receiptType.color,
				sequence = receiptType.sequence,
				versionNumber = receiptType.versionNumber,
