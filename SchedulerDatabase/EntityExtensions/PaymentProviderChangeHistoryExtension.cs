...
namespace Foundation.Scheduler.Database
{
	...
	public partial class PaymentProviderChangeHistory : IChangeHistoryEntity, IAnonymousConvertible
	{
		...
		/// <summary>
		///
		/// Converts a PaymentProviderChangeHistory to an OUTPUT Data Transfer Object.  This is the format to be used when serializing data to send back to client requests with nav properties to avoid using the PaymentProviderChangeHistoryEntity type directly.
		///
		/// </summary>
