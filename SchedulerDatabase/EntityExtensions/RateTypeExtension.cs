...
namespace Foundation.Scheduler.Database
{
	...
	public partial class RateType : IAnonymousConvertible
	{
		...
		/// <summary>
		///
		/// Converts a RateType to an OUTPUT Data Transfer Object.  This is the format to be used when serializing data to send back to client requests with nav properties to avoid using the RateTypeEntity type directly.
		///
		/// </summary>
