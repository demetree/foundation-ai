...
namespace Foundation.Scheduler.Database
{
	...
	public partial class FiscalPeriodChangeHistory : IChangeHistoryEntity, IAnonymousConvertible
	{
		...
		/// <summary>
		///
		/// Converts a FiscalPeriodChangeHistory to an OUTPUT Data Transfer Object.  This is the format to be used when serializing data to send back to client requests with nav properties to avoid using the FiscalPeriodChangeHistory Entity type directly.
		///
		/// </summary>
