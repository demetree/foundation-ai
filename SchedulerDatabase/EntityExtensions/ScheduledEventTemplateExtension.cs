...
namespace Foundation.Scheduler.Database
{
	...
	public partial class ScheduledEventTemplate : IVersionTrackedEntity<ScheduledEventTemplate>, IAnonymousConvertible
	{
		...
		/// <summary>
		///
		/// Converts a ScheduledEventTemplate to an OUTPUT Data Transfer Object.  This is the format to be used when serializing data to send back to client requests with nav properties to avoid using the ScheduledEventTemplateEntity type directly.
		///
		/// </summary>
