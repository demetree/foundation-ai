...
namespace Foundation.Scheduler.Database
{
	...
	public partial class FinancialTransaction : IVersionTrackedEntity<FinancialTransaction>, IAnonymousConvertible
	{
        ...
        /// <exception cref="ArgumentNullException"></exception>
        /// <exception cref="Exception"></exception>
        public static Task<ChangeHistoryToolset<FinancialTransaction, FinancialTransactionChangeHistory>> GetChangeHistoryToolsetForWritingAsync(SchedulerContext context, Foundation.Security.Database.SecurityUser securityUser, bool insideTransaction = false, CancellationToken cancellationToken = default)
        {
            if (context == null)
            {
                throw new ArgumentNullException(nameof(context));
            ...
            // 
            return Task.FromResult(new ChangeHistoryToolset<FinancialTransaction, FinancialTransactionChangeHistory>(context, securityUser.id, insideTransaction, cancellationToken));
        }
		...
		/// <summary>
		///
		/// Converts a FinancialTransaction to an OUTPUT Data Transfer Object.  This is the format to be used when serializing data to send back to client requests with nav properties to avoid using the FinancialTransaction Entity type directly.
		///
		/// </summary>
		...
		public void ApplyDTO(FinancialTransactionDTO dto)
		{
			...
			this.externalSystemName = dto.externalSystemName;
		...
		public static object CreateAnonymous(Database.FinancialTransaction financialTransaction)
		{
			...
			return new {
				...
				externalSystemName = financialTransaction.externalSystemName,
		...
		public static object CreateMinimalAnonymous(FinancialTransaction financialTransaction)
		{
			...
			return new {
				id = financialTransaction.id,
				description = financialTransaction.description,
				name = financialTransaction.contactRole
			 };
		}
	}
}
