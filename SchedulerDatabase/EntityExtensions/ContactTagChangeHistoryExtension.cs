...
namespace Foundation.Scheduler.Database
{
	...
	public partial class ContactTagChangeHistory : IChangeHistoryEntity, IAnonymousConvertible
	{
		...
		/// <summary>
		///
		/// Converts a ContactTagChangeHistory to an OUTPUT Data Transfer Object.  This is the format to be used when serializing data to send back to client requests with nav properties to avoid using the ContactTagChangeHistory Entity type directly.
		///
		/// </summary>
