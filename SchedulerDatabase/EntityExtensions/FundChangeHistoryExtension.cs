...
namespace Foundation.Scheduler.Database
{
	...
	public partial class FundChangeHistory : IChangeHistoryEntity, IAnonymousConvertible
	{
		...
		/// <summary>
		///
		/// Converts a FundChangeHistory to an OUTPUT Data Transfer Object.  This is the format to be used when serializing data to send back to client requests with nav properties to avoid using the FundChangeHistory Entity type directly.
		///
		/// </summary>
