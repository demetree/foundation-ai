...
namespace Foundation.Scheduler.Database
{
	...
	public partial class StateProvince : IAnonymousConvertible
	{
		...
		/// <summary>
		///
		/// Converts a StateProvince to an OUTPUT Data Transfer Object.  This is the format to be used when serializing data to send back to client requests with nav properties to avoid using the StateProvince Entity type directly.
		///
		/// </summary>
