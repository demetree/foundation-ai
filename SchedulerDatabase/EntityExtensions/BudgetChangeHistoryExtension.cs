...
namespace Foundation.Scheduler.Database
{
	...
	public partial class BudgetChangeHistory : IChangeHistoryEntity, IAnonymousConvertible
	{
		...
		/// <summary>
		///
		/// Converts a BudgetChangeHistory to an OUTPUT Data Transfer Object.  This is the format to be used when serializing data to send back to client requests with nav properties to avoid using the BudgetChangeHistoryEntity type directly.
		///
		/// </summary>
