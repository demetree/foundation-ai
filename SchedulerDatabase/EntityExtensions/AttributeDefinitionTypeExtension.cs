...
namespace Foundation.Scheduler.Database
{
	...
	public partial class AttributeDefinitionType : IAnonymousConvertible
	{
		...
		/// <summary>
		///
		/// Converts a AttributeDefinitionType to an OUTPUT Data Transfer Object.  This is the format to be used when serializing data to send back to client requests with nav properties to avoid using the AttributeDefinitionType Entity type directly.
		///
		/// </summary>
