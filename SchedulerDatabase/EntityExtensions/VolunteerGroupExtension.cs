...
namespace Foundation.Scheduler.Database
{
	...
	public partial class VolunteerGroup : IVersionTrackedEntity<VolunteerGroup>, IAnonymousConvertible
	{
		...
		/// <summary>
		///
		/// Converts a VolunteerGroup to an OUTPUT Data Transfer Object.  This is the format to be used when serializing data to send back to client requests with nav properties to avoid using the VolunteerGroupEntity type directly.
		///
		/// </summary>
