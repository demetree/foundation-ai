...
namespace Foundation.Scheduler.Database
{
	...
	public partial class CampaignChangeHistory : IChangeHistoryEntity, IAnonymousConvertible
	{
		...
		/// <summary>
		///
		/// Converts a CampaignChangeHistory to an OUTPUT Data Transfer Object.  This is the format to be used when serializing data to send back to client requests with nav properties to avoid using the CampaignChangeHistory Entity type directly.
		///
		/// </summary>
