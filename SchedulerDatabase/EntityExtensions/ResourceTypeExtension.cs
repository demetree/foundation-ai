...
namespace Foundation.Scheduler.Database
{
	...
	public partial class ResourceType : IAnonymousConvertible
	{
		...
		/// <summary>
		///
		/// Converts a ResourceType to an OUTPUT Data Transfer Object.  This is the format to be used when serializing data to send back to client requests with nav properties to avoid using the ResourceType Entity type directly.
		///
		/// </summary>
