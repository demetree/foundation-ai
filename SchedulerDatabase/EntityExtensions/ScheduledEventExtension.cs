...
namespace Foundation.Scheduler.Database
{
	...
	public partial class ScheduledEvent : IVersionTrackedEntity<ScheduledEvent>, IAnonymousConvertible
	{
		...
		/// <summary>
		///
		/// Converts a ScheduledEvent to an OUTPUT Data Transfer Object.  This is the format to be used when serializing data to send back to client requests with nav properties to avoid using the ScheduledEventEntity type directly.
		///
		/// </summary>
