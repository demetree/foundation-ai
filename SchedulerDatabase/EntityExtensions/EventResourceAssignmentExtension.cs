...
namespace Foundation.Scheduler.Database
{
	...
	public partial class EventResourceAssignment : IVersionTrackedEntity<EventResourceAssignment>, IAnonymousConvertible
	{
		...
		/// <summary>
		///
		/// Converts a EventResourceAssignment to an OUTPUT Data Transfer Object.  This is the format to be used when serializing data to send back to client requests with nav properties to avoid using the EventResourceAssignmentEntity type directly.
		///
		/// </summary>
