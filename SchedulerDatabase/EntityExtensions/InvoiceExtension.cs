...
namespace Foundation.Scheduler.Database
{
	...
	public partial class Invoice : IVersionTrackedEntity<Invoice>, IAnonymousConvertible
	{
		...
		/// <summary>
		///
		/// Converts a Invoice to an OUTPUT Data Transfer Object.  This is the format to be used when serializing data to send back to client requests with nav properties to avoid using the InvoiceEntity type directly.
		///
		/// </summary>
