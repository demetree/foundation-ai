...
namespace Foundation.Scheduler.Database
{
	...
	public partial class ScheduledEventTemplateChangeHistory : IChangeHistoryEntity, IAnonymousConvertible
	{
		...
		/// <summary>
		///
		/// Converts a ScheduledEventTemplateChangeHistory to an OUTPUT Data Transfer Object.  This is the format to be used when serializing data to send back to client requests with nav properties to avoid using the ScheduledEventTemplateChangeHistory Entity type directly.
		///
		/// </summary>
