...
namespace Foundation.Scheduler.Database
{
	...
	public partial class SchedulingTarget : IVersionTrackedEntity<SchedulingTarget>, IAnonymousConvertible
	{
		...
		/// <summary>
		///
		/// Converts a SchedulingTarget to an OUTPUT Data Transfer Object.  This is the format to be used when serializing data to send back to client requests with nav properties to avoid using the SchedulingTargetEntity type directly.
		///
		/// </summary>
