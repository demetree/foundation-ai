...
namespace Foundation.Scheduler.Database
{
	...
	public partial class Constituent : IVersionTrackedEntity<Constituent>, IAnonymousConvertible
	{
		...
		/// <summary>
		///
		/// Converts a Constituent to an OUTPUT Data Transfer Object.  This is the format to be used when serializing data to send back to client requests with nav properties to avoid using the ConstituentEntity type directly.
		///
		/// </summary>
