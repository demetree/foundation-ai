...
namespace Foundation.Scheduler.Database
{
	...
	public partial class CalendarChangeHistory : IChangeHistoryEntity, IAnonymousConvertible
	{
		...
		/// <summary>
		///
		/// Converts a CalendarChangeHistory to an OUTPUT Data Transfer Object.  This is the format to be used when serializing data to send back to client requests with nav properties to avoid using the CalendarChangeHistoryEntity type directly.
		///
		/// </summary>
