...
namespace Foundation.Scheduler.Database
{
	...
	public partial class ChargeTypeChangeHistory : IChangeHistoryEntity, IAnonymousConvertible
	{
		...
		/// <summary>
		///
		/// Converts a ChargeTypeChangeHistory to an OUTPUT Data Transfer Object.  This is the format to be used when serializing data to send back to client requests with nav properties to avoid using the ChargeTypeChangeHistoryEntity type directly.
		///
		/// </summary>
