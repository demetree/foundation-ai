...
namespace Foundation.Scheduler.Database
{
	...
	public partial class ReceiptTypeChangeHistory : IChangeHistoryEntity, IAnonymousConvertible
	{
		...
		/// <summary>
		///
		/// Converts a ReceiptTypeChangeHistory to an OUTPUT Data Transfer Object.  This is the format to be used when serializing data to send back to client requests with nav properties to avoid using the ReceiptTypeChangeHistory Entity type directly.
		///
		/// </summary>
