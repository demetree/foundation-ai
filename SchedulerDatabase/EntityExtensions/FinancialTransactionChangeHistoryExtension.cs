...
namespace Foundation.Scheduler.Database
{
	...
	public partial class FinancialTransactionChangeHistory : IChangeHistoryEntity, IAnonymousConvertible
	{
		...
		/// <summary>
		///
		/// Converts a FinancialTransactionChangeHistory to an OUTPUT Data Transfer Object.  This is the format to be used when serializing data to send back to client requests with nav properties to avoid using the FinancialTransactionChangeHistory Entity type directly.
		///
		/// </summary>
