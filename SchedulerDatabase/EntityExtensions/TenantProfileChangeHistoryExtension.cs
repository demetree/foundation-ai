...
namespace Foundation.Scheduler.Database
{
	...
	public partial class TenantProfileChangeHistory : IChangeHistoryEntity, IAnonymousConvertible
	{
		...
		/// <summary>
		///
		/// Converts a TenantProfileChangeHistory to an OUTPUT Data Transfer Object.  This is the format to be used when serializing data to send back to client requests with nav properties to avoid using the TenantProfileChangeHistory Entity type directly.
		///
		/// </summary>
