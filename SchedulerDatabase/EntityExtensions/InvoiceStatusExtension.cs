...
namespace Foundation.Scheduler.Database
{
	...
	public partial class InvoiceStatus : IAnonymousConvertible
	{
		...
		/// <summary>
		///
		/// Converts a InvoiceStatus to an OUTPUT Data Transfer Object.  This is the format to be used when serializing data to send back to client requests with nav properties to avoid using the InvoiceStatus Entity type directly.
		///
		/// </summary>
