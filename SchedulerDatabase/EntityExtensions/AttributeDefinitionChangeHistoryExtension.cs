...
namespace Foundation.Scheduler.Database
{
	...
	public partial class AttributeDefinitionChangeHistory : IChangeHistoryEntity, IAnonymousConvertible
	{
		...
		/// <summary>
		///
		/// Converts a AttributeDefinitionChangeHistory to an OUTPUT Data Transfer Object.  This is the format to be used when serializing data to send back to client requests with nav properties to avoid using the AttributeDefinitionChangeHistoryEntity type directly.
		///
		/// </summary>
