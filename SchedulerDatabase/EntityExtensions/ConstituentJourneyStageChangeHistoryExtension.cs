...
namespace Foundation.Scheduler.Database
{
	...
	public partial class ConstituentJourneyStageChangeHistory : IChangeHistoryEntity, IAnonymousConvertible
	{
		...
		/// <summary>
		///
		/// Converts a ConstituentJourneyStageChangeHistory to an OUTPUT Data Transfer Object.  This is the format to be used when serializing data to send back to client requests with nav properties to avoid using the ConstituentJourneyStageChangeHistory Entity type directly.
		///
		/// </summary>
