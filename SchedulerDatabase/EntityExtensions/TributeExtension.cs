...
namespace Foundation.Scheduler.Database
{
	...
	public partial class Tribute : IVersionTrackedEntity<Tribute>, IAnonymousConvertible
	{
		...
		/// <summary>
		///
		/// Converts a Tribute to an OUTPUT Data Transfer Object.  This is the format to be used when serializing data to send back to client requests with nav properties to avoid using the TributeEntity type directly.
		///
		/// </summary>
