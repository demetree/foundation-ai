...
namespace Foundation.Telemetry.Telemetry.Database
{
    ...
    /// <summry>
    /// 
    /// This is an extension class to the Telemetry Context that is separated from the main TelemetryContext.cs so that it won't be clobbered if the EF Core Power tools
    /// are used to rebuild the Telemetry classes
    /// 
    /// </summary>
    public partial class TelemetryContext : DbContext
    {
        ...
        public TelemetryContext(int commandTimeoutSeconds)
        {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
               ...
               .AddJsonFile("appsettings.json");
                ...
                {
                    throw new Exception("Unable to read Telemetry connection string from the appSettings.json file");
                }
            }
