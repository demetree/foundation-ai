...
namespace Foundation.Telemetry.Telemetry.Database
{
	...
	public partial class TelemetryApplication : IAnonymousConvertible
	{
		...
		///
		/// </summary>
		public static Telemetry.Database.TelemetryApplication FromDTO(TelemetryApplicationDTO dto)
		{
			return new Telemetry.Database.TelemetryApplication
			{
				id = dto.id,
				name = dto.name,
				url = dto.url,
		...
		///
		/// </summary>
		public static object CreateAnonymous(Telemetry.Database.TelemetryApplication telemetryApplication)
		{
			//
