...
/// <summry>
/// 
/// This is an extension class to the Auditor Context that is separated from the main AuditorContext.cs so that it won't be clobbered if the EF Core Power tools
