...
namespace Foundation.Scheduler.Controllers.WebAPI
{
	...
	public partial class ClientContactsController : SecureWebAPIController
	{
        ...
        /// <summary>
        /// 
        /// Gets the change metadata (version info, timestamp, user) for a specific version of a ClientContact.
        ///
        /// The rate limit is 2 per second per user.
        /// 
        /// </summary>
        /// <param name="id">The primary key of the ClientContact</param>
        /// <param name="versionNumber">The version number to retrieve metadata for</param>
        /// <returns>VersionInformation containing timestamp and user details</returns>
		[HttpGet]
		[RateLimit(RateLimitOption.TwoPerSecond, Scope = RateLimitScope.PerUser)]
		[Route("api/ClientContact/{id}/ChangeMetadata")]
		public async Task<IActionResult> GetClientContactChangeMetadata(int id, int versionNumber, CancellationToken cancellationToken = default)
		{
			...
			Database.ClientContact clientContact = await _context.ClientContacts.Where(x => x.id == id
				&& x.tenantGuid == userTenantGuid
			...
			try
			{
				clientContact.SetupVersionInquiry(_context, userTenantGuid);

				VersionInformation<Database.ClientContact> versionInfo = await clientContact.GetVersionAsync(versionNumber, includeData: false, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// 
        /// Gets the full audit history for a ClientContact.
        ///
        /// The rate limit is 2 per second per user.
        /// 
        /// </summary>
		...
		[HttpGet]
		[RateLimit(RateLimitOption.TwoPerSecond, Scope = RateLimitScope.PerUser)]
		[Route("api/ClientContact/{id}/AuditHistory")]
		public async Task<IActionResult> GetClientContactAuditHistory(int id, bool includeData = false, CancellationToken cancellationToken = default)
		{
			...
			try
			{
				...
				List<VersionInformation<Database.ClientContact>> versions = await clientContact.GetAllVersionsAsync(includeData: includeData, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// 
        /// Gets a specific version of a ClientContact.
        ///
        /// The rate limit is 2 per second per user.
        /// 
        /// </summary>
        ...
        /// <returns>The ClientContact object at that version</returns>
		[HttpGet]
		[RateLimit(RateLimitOption.TwoPerSecond, Scope = RateLimitScope.PerUser)]
		[Route("api/ClientContact/{id}/Version/{version}")]
		public async Task<IActionResult> GetClientContactVersion(int id, int version, CancellationToken cancellationToken = default)
		{
			...
			try
			{
				...
				VersionInformation<Database.ClientContact> versionInfo = await clientContact.GetVersionAsync(version, includeData: true, cancellationToken).ConfigureAwait(false);
        ...
        /// <returns>The ClientContact object at that time</returns>
		[HttpGet]
		[RateLimit(RateLimitOption.TwoPerSecond, Scope = RateLimitScope.PerUser)]
		[Route("api/ClientContact/{id}/StateAtTime")]
		public async Task<IActionResult> GetClientContactStateAtTime(int id, DateTime time, CancellationToken cancellationToken = default)
		{
			...
			try
			{
				...
				VersionInformation<Database.ClientContact> versionInfo = await clientContact.GetVersionAtTimeAsync(time, includeData: true, cancellationToken).ConfigureAwait(false);
