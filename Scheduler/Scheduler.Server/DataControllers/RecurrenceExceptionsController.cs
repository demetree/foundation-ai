...
namespace Foundation.Scheduler.Controllers.WebAPI
{
	...
	public partial class RecurrenceExceptionsController : SecureWebAPIController
	{
        ...
        /// <summary>
        /// 
        /// Gets the change metadata (version info, timestamp, user) for a specific version of a RecurrenceException.
        ///
        /// The rate limit is 2 per second per user.
        /// 
        /// </summary>
        /// <param name="id">The primary key of the RecurrenceException</param>
        /// <param name="versionNumber">The version number to retrieve metadata for</param>
        /// <returns>VersionInformation containing timestamp and user details</returns>
		[HttpGet]
		[RateLimit(RateLimitOption.TwoPerSecond, Scope = RateLimitScope.PerUser)]
		[Route("api/RecurrenceException/{id}/ChangeMetadata")]
		public async Task<IActionResult> GetRecurrenceExceptionChangeMetadata(int id, int versionNumber, CancellationToken cancellationToken = default)
		{
			if (await DoesUserHaveReadPrivilegeSecurityCheckAsync(READ_PERMISSION_LEVEL_REQUIRED, cancellationToken) == false)
			{
				return Forbid();
			...
			Database.RecurrenceException recurrenceException = await _context.RecurrenceExceptions.Where(x => x.id == id
				&& x.tenantGuid == userTenantGuid
			...
			try
			{
				recurrenceException.SetupVersionInquiry(_context, userTenantGuid);

				VersionInformation<Database.RecurrenceException> versionInfo = await recurrenceException.GetVersionAsync(versionNumber, includeData: false, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// 
        /// Gets the full audit history for a RecurrenceException.
        ///
        /// The rate limit is 2 per second per user.
        /// 
        /// </summary>
		...
		[HttpGet]
		[RateLimit(RateLimitOption.TwoPerSecond, Scope = RateLimitScope.PerUser)]
		[Route("api/RecurrenceException/{id}/AuditHistory")]
		public async Task<IActionResult> GetRecurrenceExceptionAuditHistory(int id, bool includeData = false, CancellationToken cancellationToken = default)
		{
			if (await DoesUserHaveReadPrivilegeSecurityCheckAsync(READ_PERMISSION_LEVEL_REQUIRED, cancellationToken) == false)
			{
				return Forbid();
			...
			try
			{
				...
				List<VersionInformation<Database.RecurrenceException>> versions = await recurrenceException.GetAllVersionsAsync(includeData: includeData, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// 
        /// Gets a specific version of a RecurrenceException.
        ///
        /// The rate limit is 2 per second per user.
        /// 
        /// </summary>
        ...
        /// <returns>The RecurrenceException object at that version</returns>
		[HttpGet]
		[RateLimit(RateLimitOption.TwoPerSecond, Scope = RateLimitScope.PerUser)]
		[Route("api/RecurrenceException/{id}/Version/{version}")]
		public async Task<IActionResult> GetRecurrenceExceptionVersion(int id, int version, CancellationToken cancellationToken = default)
		{
			if (await DoesUserHaveReadPrivilegeSecurityCheckAsync(READ_PERMISSION_LEVEL_REQUIRED, cancellationToken) == false)
			{
				return Forbid();
			...
			try
			{
				...
				VersionInformation<Database.RecurrenceException> versionInfo = await recurrenceException.GetVersionAsync(version, includeData: true, cancellationToken).ConfigureAwait(false);
        ...
        /// <returns>The RecurrenceException object at that time</returns>
		[HttpGet]
		[RateLimit(RateLimitOption.TwoPerSecond, Scope = RateLimitScope.PerUser)]
		[Route("api/RecurrenceException/{id}/StateAtTime")]
		public async Task<IActionResult> GetRecurrenceExceptionStateAtTime(int id, DateTime time, CancellationToken cancellationToken = default)
		{
			if (await DoesUserHaveReadPrivilegeSecurityCheckAsync(READ_PERMISSION_LEVEL_REQUIRED, cancellationToken) == false)
			{
				return Forbid();
			...
			try
			{
				...
				VersionInformation<Database.RecurrenceException> versionInfo = await recurrenceException.GetVersionAtTimeAsync(time, includeData: true, cancellationToken).ConfigureAwait(false);
