...
namespace Foundation.Scheduler.Controllers.WebAPI
{
	...
	public partial class ScheduledEventDependenciesController : SecureWebAPIController
	{
        ...
        /// <summary>
        /// 
        /// Gets the change metadata (version info, timestamp, user) for a specific version of a ScheduledEventDependency.
        ///
        /// The rate limit is 2 per second per user.
        /// 
        /// </summary>
        /// <param name="id">The primary key of the ScheduledEventDependency</param>
        /// <param name="versionNumber">The version number to retrieve metadata for</param>
        /// <returns>VersionInformation containing timestamp and user details</returns>
		[HttpGet]
		[RateLimit(RateLimitOption.TwoPerSecond, Scope = RateLimitScope.PerUser)]
		[Route("api/ScheduledEventDependency/{id}/ChangeMetadata")]
		public async Task<IActionResult> GetScheduledEventDependencyChangeMetadata(int id, int versionNumber, CancellationToken cancellationToken = default)
		{
			...
			Database.ScheduledEventDependency scheduledEventDependency = await _context.ScheduledEventDependencies.Where(x => x.id == id
				&& x.tenantGuid == userTenantGuid
			...
			try
			{
				scheduledEventDependency.SetupVersionInquiry(_context, userTenantGuid);

				VersionInformation<Database.ScheduledEventDependency> versionInfo = await scheduledEventDependency.GetVersionAsync(versionNumber, includeData: false, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// 
        /// Gets the full audit history for a ScheduledEventDependency.
        ///
        /// The rate limit is 2 per second per user.
        /// 
        /// </summary>
		...
		[HttpGet]
		[RateLimit(RateLimitOption.TwoPerSecond, Scope = RateLimitScope.PerUser)]
		[Route("api/ScheduledEventDependency/{id}/AuditHistory")]
		public async Task<IActionResult> GetScheduledEventDependencyAuditHistory(int id, bool includeData = false, CancellationToken cancellationToken = default)
		{
			...
			try
			{
				...
				List<VersionInformation<Database.ScheduledEventDependency>> versions = await scheduledEventDependency.GetAllVersionsAsync(includeData: includeData, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// 
        /// Gets a specific version of a ScheduledEventDependency.
        ///
        /// The rate limit is 2 per second per user.
        /// 
        /// </summary>
        ...
        /// <returns>The ScheduledEventDependency object at that version</returns>
		[HttpGet]
		[RateLimit(RateLimitOption.TwoPerSecond, Scope = RateLimitScope.PerUser)]
		[Route("api/ScheduledEventDependency/{id}/Version/{version}")]
		public async Task<IActionResult> GetScheduledEventDependencyVersion(int id, int version, CancellationToken cancellationToken = default)
		{
			...
			try
			{
				...
				VersionInformation<Database.ScheduledEventDependency> versionInfo = await scheduledEventDependency.GetVersionAsync(version, includeData: true, cancellationToken).ConfigureAwait(false);
        ...
        /// <returns>The ScheduledEventDependency object at that time</returns>
		[HttpGet]
		[RateLimit(RateLimitOption.TwoPerSecond, Scope = RateLimitScope.PerUser)]
		[Route("api/ScheduledEventDependency/{id}/StateAtTime")]
		public async Task<IActionResult> GetScheduledEventDependencyStateAtTime(int id, DateTime time, CancellationToken cancellationToken = default)
		{
			...
			try
			{
				...
				VersionInformation<Database.ScheduledEventDependency> versionInfo = await scheduledEventDependency.GetVersionAtTimeAsync(time, includeData: true, cancellationToken).ConfigureAwait(false);
