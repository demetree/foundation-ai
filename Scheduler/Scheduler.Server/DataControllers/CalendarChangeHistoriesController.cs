...
namespace Foundation.Scheduler.Controllers.WebAPI
{
	...
	public partial class CalendarChangeHistoriesController : SecureWebAPIController
	{
			...
			CancellationToken cancellationToken = default)
		{
			...
			//
			// Add the any string contains parameter to span all the string fields on the Calendar Change History, or on an any of the string fields on its immediate relations
			//
