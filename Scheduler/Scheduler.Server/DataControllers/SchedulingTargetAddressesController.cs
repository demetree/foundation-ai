...
namespace Foundation.Scheduler.Controllers.WebAPI
{
	...
	public partial class SchedulingTargetAddressesController : SecureWebAPIController
	{
        ...
        /// <summary>
        /// 
        /// Gets the change metadata (version info, timestamp, user) for a specific version of a SchedulingTargetAddress.
        ///
        /// The rate limit is 2 per second per user.
        /// 
        /// </summary>
        /// <param name="id">The primary key of the SchedulingTargetAddress</param>
        /// <param name="versionNumber">The version number to retrieve metadata for</param>
        /// <returns>VersionInformation containing timestamp and user details</returns>
		[HttpGet]
		[RateLimit(RateLimitOption.TwoPerSecond, Scope = RateLimitScope.PerUser)]
		[Route("api/SchedulingTargetAddress/{id}/ChangeMetadata")]
		public async Task<IActionResult> GetSchedulingTargetAddressChangeMetadata(int id, int versionNumber, CancellationToken cancellationToken = default)
		{
			if (await DoesUserHaveReadPrivilegeSecurityCheckAsync(READ_PERMISSION_LEVEL_REQUIRED, cancellationToken) == false)
			{
				return Forbid();
			...
			Database.SchedulingTargetAddress schedulingTargetAddress = await _context.SchedulingTargetAddresses.Where(x => x.id == id
				&& x.tenantGuid == userTenantGuid
			...
			try
			{
				schedulingTargetAddress.SetupVersionInquiry(_context, userTenantGuid);

				VersionInformation<Database.SchedulingTargetAddress> versionInfo = await schedulingTargetAddress.GetVersionAsync(versionNumber, includeData: false, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// 
        /// Gets the full audit history for a SchedulingTargetAddress.
        ///
        /// The rate limit is 2 per second per user.
        /// 
        /// </summary>
		...
		[HttpGet]
		[RateLimit(RateLimitOption.TwoPerSecond, Scope = RateLimitScope.PerUser)]
		[Route("api/SchedulingTargetAddress/{id}/AuditHistory")]
		public async Task<IActionResult> GetSchedulingTargetAddressAuditHistory(int id, bool includeData = false, CancellationToken cancellationToken = default)
		{
			if (await DoesUserHaveReadPrivilegeSecurityCheckAsync(READ_PERMISSION_LEVEL_REQUIRED, cancellationToken) == false)
			{
				return Forbid();
			...
			try
			{
				...
				List<VersionInformation<Database.SchedulingTargetAddress>> versions = await schedulingTargetAddress.GetAllVersionsAsync(includeData: includeData, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// 
        /// Gets a specific version of a SchedulingTargetAddress.
        ///
        /// The rate limit is 2 per second per user.
        /// 
        /// </summary>
        ...
        /// <returns>The SchedulingTargetAddress object at that version</returns>
		[HttpGet]
		[RateLimit(RateLimitOption.TwoPerSecond, Scope = RateLimitScope.PerUser)]
		[Route("api/SchedulingTargetAddress/{id}/Version/{version}")]
		public async Task<IActionResult> GetSchedulingTargetAddressVersion(int id, int version, CancellationToken cancellationToken = default)
		{
			if (await DoesUserHaveReadPrivilegeSecurityCheckAsync(READ_PERMISSION_LEVEL_REQUIRED, cancellationToken) == false)
			{
				return Forbid();
			...
			try
			{
				...
				VersionInformation<Database.SchedulingTargetAddress> versionInfo = await schedulingTargetAddress.GetVersionAsync(version, includeData: true, cancellationToken).ConfigureAwait(false);
        ...
        /// <returns>The SchedulingTargetAddress object at that time</returns>
		[HttpGet]
		[RateLimit(RateLimitOption.TwoPerSecond, Scope = RateLimitScope.PerUser)]
		[Route("api/SchedulingTargetAddress/{id}/StateAtTime")]
		public async Task<IActionResult> GetSchedulingTargetAddressStateAtTime(int id, DateTime time, CancellationToken cancellationToken = default)
		{
			if (await DoesUserHaveReadPrivilegeSecurityCheckAsync(READ_PERMISSION_LEVEL_REQUIRED, cancellationToken) == false)
			{
				return Forbid();
			...
			try
			{
				...
				VersionInformation<Database.SchedulingTargetAddress> versionInfo = await schedulingTargetAddress.GetVersionAtTimeAsync(time, includeData: true, cancellationToken).ConfigureAwait(false);
