...
export class ConstituentData {
    ...
    //
    private _currentVersionInfo: VersionInformation<ConstituentData> | null = null;
    private _currentVersionInfoPromise: Promise<VersionInformation<ConstituentData>> | null = null;
    private _currentVersionInfoSubject = new BehaviorSubject<VersionInformation<ConstituentData> | null>(null);
  ...
  private clearAllLazyCaches(): void {
    ...
    */
    ...
    //
    // Usage examples:
    //   Template: {{ (constituent.CurrentVersionInfo$ | async)?.userName }}
    //   Code:     const info = await constituent.CurrentVersionInfo;
    //
    ...
    public get CurrentVersionInfo(): Promise<VersionInformation<ConstituentData>> {
    ...
    private async loadCurrentVersionInfo(): Promise<VersionInformation<ConstituentData>> {
        const info = await lastValueFrom(
            ConstituentService.Instance.GetConstituentChangeMetadata(this.id, this.versionNumber as number)
        );
...
export class ConstituentService extends SecureEndpointBase {
    ...
    /**
     * Gets version metadata for a specific version of a Constituent.
     */
    public GetConstituentChangeMetadata(id: bigint | number, versionNumber?: number): Observable<VersionInformation<ConstituentData>> {
        ...
        return this.http.get<VersionInformation<ConstituentData>>(this.baseUrl + 'api/Constituent/' + id.toString() + '/ChangeMetadata', {
            params: queryParams,
            headers: authenticationHeaders
        }).pipe(
            catchError(error => {
                return this.handleError(error, () => this.GetConstituentChangeMetadata(id, versionNumber));
            })
        );
    }
    ...
    /**
     * Gets the full audit history of a Constituent.
     */
    public GetConstituentAuditHistory(id: bigint | number, includeData: boolean = false): Observable<VersionInformation<ConstituentData>[]> {
        ...
        return this.http.get<VersionInformation<ConstituentData>[]>(this.baseUrl + 'api/Constituent/' + id.toString() + '/AuditHistory', {
            params: queryParams,
            headers: authenticationHeaders
        }).pipe(
            catchError(error => {
                return this.handleError(error, () => this.GetConstituentAuditHistory(id, includeData));
            })
        );
    }
    ...
    /**
     * Gets a specific historical version of a Constituent.
     */
    public GetConstituentVersion(id: bigint | number, version: number): Observable<ConstituentData> {

        const authenticationHeaders = this.authService.GetAuthenticationHeaders();

        return this.http.get<ConstituentData>(this.baseUrl + 'api/Constituent/' + id.toString() + '/Version/' + version.toString(), {
            headers: authenticationHeaders
        }).pipe(
            map(raw => this.ReviveConstituent(raw)),
            catchError(error => {
                return this.handleError(error, () => this.GetConstituentVersion(id, version));
            })
        );
    }
    ...
    /**
     * Gets the state of a Constituent at a specific point in time.
     */
    public GetConstituentStateAtTime(id: bigint | number, time: string): Observable<ConstituentData> {
        ...
        return this.http.get<ConstituentData>(this.baseUrl + 'api/Constituent/' + id.toString() + '/StateAtTime', {
            params: queryParams,
            headers: authenticationHeaders
        }).pipe(
            map(raw => this.ReviveConstituent(raw)),
            catchError(error => {
                return this.handleError(error, () => this.GetConstituentStateAtTime(id, time));
            })
        );
    }
 ...
 /**
  ...
  public ReviveConstituent(raw: any): ConstituentData {
    ...
    (revived as any)._currentVersionInfoSubject = new BehaviorSubject<VersionInformation<ConstituentData> | null>(null);
