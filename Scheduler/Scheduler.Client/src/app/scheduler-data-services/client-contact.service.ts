...
export class ClientContactService extends SecureEndpointBase {
    ...
    public userIsSchedulerClientContactWriter(): boolean {
        ...
        if (userIsSchedulerClientContactWriter == true) {
          ...
          if (user != null) {
            userIsSchedulerClientContactWriter = user.writePermission >= 1;
          } else {
 ...
 /**
  ...
  public ReviveClientContact(raw: any): ClientContactData {
    ...
    (revived as any).ClientContactChangeHistoriesCount$ = ClientContactChangeHistoryService.Instance.GetClientContactChangeHistoriesRowCount({clientContactId: (revived as any).id,
      active: true,
      deleted: false
    });
