...
export class AssignmentRoleQualificationRequirementData {
    ...
    //
    private _currentVersionInfo: VersionInformation<AssignmentRoleQualificationRequirementData> | null = null;
    private _currentVersionInfoPromise: Promise<VersionInformation<AssignmentRoleQualificationRequirementData>> | null = null;
    private _currentVersionInfoSubject = new BehaviorSubject<VersionInformation<AssignmentRoleQualificationRequirementData> | null>(null);
  ...
  private clearAllLazyCaches(): void {
    ...
    */
    ...
    //
    // Usage examples:
    //   Template: {{ (assignmentRoleQualificationRequirement.CurrentVersionInfo$ | async)?.userName }}
    //   Code:     const info = await assignmentRoleQualificationRequirement.CurrentVersionInfo;
    //
    ...
    public get CurrentVersionInfo(): Promise<VersionInformation<AssignmentRoleQualificationRequirementData>> {
    ...
    private async loadCurrentVersionInfo(): Promise<VersionInformation<AssignmentRoleQualificationRequirementData>> {
        const info = await lastValueFrom(
            AssignmentRoleQualificationRequirementService.Instance.GetAssignmentRoleQualificationRequirementChangeMetadata(this.id, this.versionNumber as number)
        );
...
export class AssignmentRoleQualificationRequirementService extends SecureEndpointBase {
    ...
    /**
     * Gets version metadata for a specific version of a AssignmentRoleQualificationRequirement.
     */
    public GetAssignmentRoleQualificationRequirementChangeMetadata(id: bigint | number, versionNumber?: number): Observable<VersionInformation<AssignmentRoleQualificationRequirementData>> {
        ...
        return this.http.get<VersionInformation<AssignmentRoleQualificationRequirementData>>(this.baseUrl + 'api/AssignmentRoleQualificationRequirement/' + id.toString() + '/ChangeMetadata', {
            params: queryParams,
            headers: authenticationHeaders
        }).pipe(
            catchError(error => {
                return this.handleError(error, () => this.GetAssignmentRoleQualificationRequirementChangeMetadata(id, versionNumber));
            })
        );
    }
    ...
    /**
     * Gets the full audit history of a AssignmentRoleQualificationRequirement.
     */
    public GetAssignmentRoleQualificationRequirementAuditHistory(id: bigint | number, includeData: boolean = false): Observable<VersionInformation<AssignmentRoleQualificationRequirementData>[]> {
        ...
        return this.http.get<VersionInformation<AssignmentRoleQualificationRequirementData>[]>(this.baseUrl + 'api/AssignmentRoleQualificationRequirement/' + id.toString() + '/AuditHistory', {
            params: queryParams,
            headers: authenticationHeaders
        }).pipe(
            catchError(error => {
                return this.handleError(error, () => this.GetAssignmentRoleQualificationRequirementAuditHistory(id, includeData));
            })
        );
    }
    ...
    /**
     * Gets a specific historical version of a AssignmentRoleQualificationRequirement.
     */
    public GetAssignmentRoleQualificationRequirementVersion(id: bigint | number, version: number): Observable<AssignmentRoleQualificationRequirementData> {

        const authenticationHeaders = this.authService.GetAuthenticationHeaders();

        return this.http.get<AssignmentRoleQualificationRequirementData>(this.baseUrl + 'api/AssignmentRoleQualificationRequirement/' + id.toString() + '/Version/' + version.toString(), {
            headers: authenticationHeaders
        }).pipe(
            map(raw => this.ReviveAssignmentRoleQualificationRequirement(raw)),
            catchError(error => {
                return this.handleError(error, () => this.GetAssignmentRoleQualificationRequirementVersion(id, version));
            })
        );
    }
     ...
     */
    public GetAssignmentRoleQualificationRequirementStateAtTime(id: bigint | number, time: string): Observable<AssignmentRoleQualificationRequirementData> {
        ...
        return this.http.get<AssignmentRoleQualificationRequirementData>(this.baseUrl + 'api/AssignmentRoleQualificationRequirement/' + id.toString() + '/StateAtTime', {
            params: queryParams,
            headers: authenticationHeaders
        }).pipe(
            map(raw => this.ReviveAssignmentRoleQualificationRequirement(raw)),
            catchError(error => {
                return this.handleError(error, () => this.GetAssignmentRoleQualificationRequirementStateAtTime(id, time));
            })
        );
    }
 ...
 /**
  ...
  public ReviveAssignmentRoleQualificationRequirement(raw: any): AssignmentRoleQualificationRequirementData {
    ...
    (revived as any)._currentVersionInfoSubject = new BehaviorSubject<VersionInformation<AssignmentRoleQualificationRequirementData> | null>(null);
