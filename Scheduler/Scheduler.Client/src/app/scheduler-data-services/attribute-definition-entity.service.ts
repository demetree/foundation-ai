...
export class AttributeDefinitionEntityService extends SecureEndpointBase {
    ...
    public userIsSchedulerAttributeDefinitionEntityWriter(): boolean {
        ...
        if (userIsSchedulerAttributeDefinitionEntityWriter == true) {
          ...
          if (user != null) {
            userIsSchedulerAttributeDefinitionEntityWriter = user.writePermission >= 50;
          } else {
 ...
 /**
  ...
  public ReviveAttributeDefinitionEntity(raw: any): AttributeDefinitionEntityData {
    ...
    (revived as any).AttributeDefinitionsCount$ = AttributeDefinitionService.Instance.GetAttributeDefinitionsRowCount({attributeDefinitionEntityId: (revived as any).id,
      active: true,
      deleted: false
    });
