    ...
    setTimeout(() => {
      if (this.isUserLoggedIn) {
        ...
        if (this.authService.isSchedulerReader == false) {
          ...
          this.alertService.showMessage(this.gT('app.alerts.Login'), "Your account does not have the privilege to read from the Scheduler Module", MessageSeverity.error);
