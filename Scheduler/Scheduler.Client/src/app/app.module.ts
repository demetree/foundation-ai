...
import { EventTimelinePanelComponent } from './components/scheduler/event-timeline-panel/event-timeline-panel.component';
...
@NgModule({
  ...
  declarations: [
    ...
    RevenueByClientReportComponent,
    GiftEntryComponent,
