...
@Component({
  selector: 'app-resource-custom-table',
  templateUrl: './resource-custom-table.component.html',
  styleUrls: ['./resource-custom-table.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class ResourceCustomTableComponent implements OnInit, OnChanges, AfterViewInit {
