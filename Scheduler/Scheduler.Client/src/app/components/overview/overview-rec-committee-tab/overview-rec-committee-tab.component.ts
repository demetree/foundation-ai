...
@Component({
  selector: 'app-overview-rec-committee-tab',
  templateUrl: './overview-rec-committee-tab.component.html',
  styleUrls: ['./overview-rec-committee-tab.component.scss']
})
export class OverviewRecCommitteeTabComponent implements OnInit, OnDestroy {
