  ...
  */
  ...
  private buildFormValues(tenantProfileData: TenantProfileData | null) {
    ...
    if (tenantProfileData == null) {
      ...
      this.tenantProfileForm.reset({
        ...
        invoiceNumberMask: tenantProfileData.invoiceNumberMask ?? '',
        receiptNumberMask: tenantProfileData.receiptNumberMask ?? '',
  ...
  public submitForm() {
    ...
    const tenantProfileSubmitData: TenantProfileSubmitData = {
        ...
        invoiceNumberMask: formValue.invoiceNumberMask?.trim() || null,
        receiptNumberMask: formValue.receiptNumberMask?.trim() || null,
