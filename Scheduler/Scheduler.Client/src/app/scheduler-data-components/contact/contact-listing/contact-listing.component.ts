...
export class ContactListingComponent implements OnInit, AfterViewInit, CanComponentDeactivate {
  @ViewChild(ContactAddEditComponent) addEditContactComponent!: ContactAddEditComponent;
  @ViewChild(ContactTableComponent) contactTableComponent!: ContactTableComponent;
  ...
  private loadCounts(): void {
    ...
    if (this.filterText) {
      ...
      this.filteredContactCount$ = this.totalContactCount$; // No filter, so assign to be same as total observable
      this.loadingFilteredCount = false;
    }
  ...
  public onFilterChange(): void {
    ...
    this.debounceTimeout = setTimeout(() => {
      this.contactTableComponent.resetToFirstPage(); // Reset to page 1 on filter change
