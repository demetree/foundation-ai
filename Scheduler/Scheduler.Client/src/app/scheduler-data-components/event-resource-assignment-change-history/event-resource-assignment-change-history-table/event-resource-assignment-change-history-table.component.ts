...
export class EventResourceAssignmentChangeHistoryTableComponent implements OnInit, OnChanges, AfterViewInit {
 ...
 /**
  ...
  public handleAdd(): void {
    if (this.addEditEventResourceAssignmentChangeHistoryComponent)
    {
        this.addEditEventResourceAssignmentChangeHistoryComponent.openModal(); // Open in add mode (no data)
    }
}
