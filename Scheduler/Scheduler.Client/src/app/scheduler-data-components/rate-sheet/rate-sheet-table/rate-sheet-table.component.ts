...
@Component({
  selector: 'app-rate-sheet-table',
  templateUrl: './rate-sheet-table.component.html',
  styleUrls: ['./rate-sheet-table.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class RateSheetTableComponent implements OnInit, OnChanges, AfterViewInit {
 ...
 /**
  ...
  private buildDefaultColumns(): void {
    ...
    { key: 'costRate', label: 'Cost Rate', width: undefined },
    { key: 'billingRate', label: 'Billing Rate', width: undefined },
  ...
  public handleAdd(): void {
    if (this.addEditRateSheetComponent)
    {
        this.addEditRateSheetComponent.openModal(); // Open in add mode (no data)
    }
}
