...
export class SchedulingTargetAddressChangeHistoryTableComponent implements OnInit, OnChanges, AfterViewInit {
 ...
 /**
  ...
  public handleAdd(): void {
    if (this.addEditSchedulingTargetAddressChangeHistoryComponent)
    {
        this.addEditSchedulingTargetAddressChangeHistoryComponent.openModal(); // Open in add mode (no data)
    }
}
