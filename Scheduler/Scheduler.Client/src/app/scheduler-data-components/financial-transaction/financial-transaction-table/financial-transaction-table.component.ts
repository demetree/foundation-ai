...
export class FinancialTransactionTableComponent implements OnInit, OnChanges, AfterViewInit {
 ...
 /**
  ...
  private buildDefaultColumns(): void {
    ...
    { key: 'contactRole', label: 'Contact Role', width: undefined, mobile: 'prominent', template: 'link', linkPath: ['/financialtransaction', 'id']  },
    ...
    { key: 'journalEntryType', label: 'Journal Entry Type', width: undefined },
    ...
    { key: 'externalSystemName', label: 'External System Name', width: undefined },
