...
export class ScheduledEventTableComponent implements OnInit, OnChanges, AfterViewInit {
 ...
 /**
  ...
  private buildDefaultColumns(): void {
    ...
    { key: 'bookingContactName', label: 'Booking Contact Name', width: undefined },
    { key: 'bookingContactEmail', label: 'Booking Contact Email', width: undefined },
    { key: 'bookingContactPhone', label: 'Booking Contact Phone', width: undefined },
  ...
  public handleAdd(): void {
    if (this.addEditScheduledEventComponent)
    {
        this.addEditScheduledEventComponent.openModal(); // Open in add mode (no data)
    }
}
