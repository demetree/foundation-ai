...
export class VolunteerProfileAddEditComponent {
  ...
  submitForm() {
    ...
    const volunteerProfileSubmitData: VolunteerProfileSubmitData = {
        ...
        onboardedDate: formValue.onboardedDate?.trim() || null,
        inactiveSince: formValue.inactiveSince?.trim() || null,
        totalHoursServed: formValue.totalHoursServed ? Number(formValue.totalHoursServed) : null,
        lastActivityDate: formValue.lastActivityDate?.trim() || null,
        backgroundCheckCompleted: !!formValue.backgroundCheckCompleted,
        backgroundCheckDate: formValue.backgroundCheckDate?.trim() || null,
        backgroundCheckExpiry: formValue.backgroundCheckExpiry?.trim() || null,
        confidentialityAgreementSigned: !!formValue.confidentialityAgreementSigned,
        confidentialityAgreementDate: formValue.confidentialityAgreementDate?.trim() || null,
