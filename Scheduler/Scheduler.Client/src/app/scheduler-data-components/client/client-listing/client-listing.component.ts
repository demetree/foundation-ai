...
export class ClientListingComponent implements OnInit, AfterViewInit, CanComponentDeactivate {
  @ViewChild(ClientAddEditComponent) addEditClientComponent!: ClientAddEditComponent;
  ...
  public onFilterChange(): void {
    ...
    this.debounceTimeout = setTimeout(() => {
      this.clientTableComponent.resetToFirstPage(); // Reset to page 1 on filter change
