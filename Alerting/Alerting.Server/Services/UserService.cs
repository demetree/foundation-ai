...
namespace Alerting.Server.Services
{
    ...
    public class UserService : IUserService
    {
        ...
        /// <summary>
        /// 
        /// Project a Seucirty user to a User object
        /// 
        /// </summary>
        /// <param name="su"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// 
        /// Get all of the applicable security users
        /// 
        /// </summary>
        ...
        /// <returns></returns>
        private async Task<List<User>> GetApplicableUsersAsync(Guid tenantGuid,
                                                               Guid? teamGuid = null,
                                                               Guid? userGuid = null,
                                                               CancellationToken cancellationToken = default)
        {
            var query = from stu in _securityContext.SecurityTenantUsers
                        ...
                        where st.objectGuid == tenantGuid &&
                              ...
                              m.active && !m.deleted &&
                              m.name == "Alerting"          // Must have a role in the Alerting module
                        select su;
            ...
            return securityUsers.DistinctBy(su => su.objectGuid)
