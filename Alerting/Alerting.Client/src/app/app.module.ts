...
import { UserPushTokenAddEditComponent } from './alerting-data-components/user-push-token/user-push-token-add-edit/user-push-token-add-edit.component';
...
import { UserPushTokenTableComponent } from './alerting-data-components/user-push-token/user-push-token-table/user-push-token-table.component';
...
import { UserPushTokenChangeHistoryAddEditComponent } from './alerting-data-components/user-push-token-change-history/user-push-token-change-history-add-edit/user-push-token-change-history-add-edit.component';
...
import { UserPushTokenChangeHistoryTableComponent } from './alerting-data-components/user-push-token-change-history/user-push-token-change-history-table/user-push-token-change-history-table.component';
...
UserPushTokenListingComponent,
UserPushTokenAddEditComponent,
UserPushTokenDetailComponent,
UserPushTokenTableComponent,
UserPushTokenChangeHistoryListingComponent,
UserPushTokenChangeHistoryAddEditComponent,
UserPushTokenChangeHistoryDetailComponent,
UserPushTokenChangeHistoryTableComponent,
...
UserPushTokenChangeHistoryService,
