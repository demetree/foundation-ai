...
import { ServiceHealthMatrixComponent } from './components/service-health-matrix/service-health-matrix.component';
import { NotificationAuditComponent } from './components/notification-audit/notification-audit.component';
...
import { UserPushTokenListingComponent } from './alerting-data-components/user-push-token/user-push-token-listing/user-push-token-listing.component';
import { UserPushTokenDetailComponent } from './alerting-data-components/user-push-token/user-push-token-detail/user-push-token-detail.component';
import { UserPushTokenChangeHistoryListingComponent } from './alerting-data-components/user-push-token-change-history/user-push-token-change-history-listing/user-push-token-change-history-listing.component';
import { UserPushTokenChangeHistoryDetailComponent } from './alerting-data-components/user-push-token-change-history/user-push-token-change-history-detail/user-push-token-change-history-detail.component';
...
const routes: Routes = [
  ...
  { path: 'admin-notification-preferences', component: AdminNotificationPreferencesComponent, canActivate: [AuthGuard], title: 'Admin Notification Preferences' },
  { path: 'service-health', component: ServiceHealthMatrixComponent, canActivate: [AuthGuard], title: 'Service Health Matrix' },
  { path: 'notification-audit', component: NotificationAuditComponent, canActivate: [AuthGuard], title: 'Notification Audit' },
  ...
  { path: 'integrationcallbackincidenteventtypes', component: IntegrationCallbackIncidentEventTypeListingComponent, canActivate: [AuthGuard], canDeactivate: [UnsavedChangesGuard], title: 'Integration Callback Incident Event Types' },
  { path: 'integrationcallbackincidenteventtypes/new', component: IntegrationCallbackIncidentEventTypeDetailComponent, canActivate: [AuthGuard], canDeactivate: [UnsavedChangesGuard], title: 'Create Integration Callback Incident Event Type' },
  { path: 'integrationcallbackincidenteventtypes/:integrationCallbackIncidentEventTypeId', component: IntegrationCallbackIncidentEventTypeDetailComponent, canActivate: [AuthGuard], canDeactivate: [UnsavedChangesGuard], title: 'Edit Integration Callback Incident Event Type' },
  { path: 'integrationcallbackincidenteventtype/:integrationCallbackIncidentEventTypeId', component: IntegrationCallbackIncidentEventTypeDetailComponent, canActivate: [AuthGuard], canDeactivate: [UnsavedChangesGuard], title: 'Edit Integration Callback Incident Event Type' },
  { path: 'integrationcallbackincidenteventtype', redirectTo: 'integrationcallbackincidenteventtypes' },
  { path: 'integrationcallbackincidenteventtypechangehistories', component: IntegrationCallbackIncidentEventTypeChangeHistoryListingComponent, canActivate: [AuthGuard], canDeactivate: [UnsavedChangesGuard], title: 'Integration Callback Incident Event Type Change Histories' },
  { path: 'integrationcallbackincidenteventtypechangehistories/new', component: IntegrationCallbackIncidentEventTypeChangeHistoryDetailComponent, canActivate: [AuthGuard], canDeactivate: [UnsavedChangesGuard], title: 'Create Integration Callback Incident Event Type Change History' },
  { path: 'integrationcallbackincidenteventtypechangehistories/:integrationCallbackIncidentEventTypeChangeHistoryId', component: IntegrationCallbackIncidentEventTypeChangeHistoryDetailComponent, canActivate: [AuthGuard], canDeactivate: [UnsavedChangesGuard], title: 'Edit Integration Callback Incident Event Type Change History' },
  { path: 'integrationcallbackincidenteventtypechangehistory/:integrationCallbackIncidentEventTypeChangeHistoryId', component: IntegrationCallbackIncidentEventTypeChangeHistoryDetailComponent, canActivate: [AuthGuard], canDeactivate: [UnsavedChangesGuard], title: 'Edit Integration Callback Incident Event Type Change History' },
  { path: 'integrationcallbackincidenteventtypechangehistory', redirectTo: 'integrationcallbackincidenteventtypechangehistories' },
  ...
  { path: 'scheduleoverrides', component: ScheduleOverrideListingComponent, canActivate: [AuthGuard], canDeactivate: [UnsavedChangesGuard], title: 'Schedule Overrides' },
  { path: 'scheduleoverrides/new', component: ScheduleOverrideDetailComponent, canActivate: [AuthGuard], canDeactivate: [UnsavedChangesGuard], title: 'Create Schedule Override' },
  { path: 'scheduleoverrides/:scheduleOverrideId', component: ScheduleOverrideDetailComponent, canActivate: [AuthGuard], canDeactivate: [UnsavedChangesGuard], title: 'Edit Schedule Override' },
  { path: 'scheduleoverride/:scheduleOverrideId', component: ScheduleOverrideDetailComponent, canActivate: [AuthGuard], canDeactivate: [UnsavedChangesGuard], title: 'Edit Schedule Override' },
  { path: 'scheduleoverride', redirectTo: 'scheduleoverrides' },
  { path: 'scheduleoverridechangehistories', component: ScheduleOverrideChangeHistoryListingComponent, canActivate: [AuthGuard], canDeactivate: [UnsavedChangesGuard], title: 'Schedule Override Change Histories' },
  { path: 'scheduleoverridechangehistories/new', component: ScheduleOverrideChangeHistoryDetailComponent, canActivate: [AuthGuard], canDeactivate: [UnsavedChangesGuard], title: 'Create Schedule Override Change History' },
  { path: 'scheduleoverridechangehistories/:scheduleOverrideChangeHistoryId', component: ScheduleOverrideChangeHistoryDetailComponent, canActivate: [AuthGuard], canDeactivate: [UnsavedChangesGuard], title: 'Edit Schedule Override Change History' },
  { path: 'scheduleoverridechangehistory/:scheduleOverrideChangeHistoryId', component: ScheduleOverrideChangeHistoryDetailComponent, canActivate: [AuthGuard], canDeactivate: [UnsavedChangesGuard], title: 'Edit Schedule Override Change History' },
  { path: 'scheduleoverridechangehistory', redirectTo: 'scheduleoverridechangehistories' },
  { path: 'scheduleoverridetypes', component: ScheduleOverrideTypeListingComponent, canActivate: [AuthGuard], canDeactivate: [UnsavedChangesGuard], title: 'Schedule Override Types' },
  { path: 'scheduleoverridetypes/new', component: ScheduleOverrideTypeDetailComponent, canActivate: [AuthGuard], canDeactivate: [UnsavedChangesGuard], title: 'Create Schedule Override Type' },
  { path: 'scheduleoverridetypes/:scheduleOverrideTypeId', component: ScheduleOverrideTypeDetailComponent, canActivate: [AuthGuard], canDeactivate: [UnsavedChangesGuard], title: 'Edit Schedule Override Type' },
  { path: 'scheduleoverridetype/:scheduleOverrideTypeId', component: ScheduleOverrideTypeDetailComponent, canActivate: [AuthGuard], canDeactivate: [UnsavedChangesGuard], title: 'Edit Schedule Override Type' },
  { path: 'scheduleoverridetype', redirectTo: 'scheduleoverridetypes' },
  ...
  { path: 'userpushtokens', component: UserPushTokenListingComponent, canActivate: [AuthGuard], canDeactivate: [UnsavedChangesGuard], title: 'User Push Tokens' },
  { path: 'userpushtokens/new', component: UserPushTokenDetailComponent, canActivate: [AuthGuard], canDeactivate: [UnsavedChangesGuard], title: 'Create User Push Token' },
  { path: 'userpushtokens/:userPushTokenId', component: UserPushTokenDetailComponent, canActivate: [AuthGuard], canDeactivate: [UnsavedChangesGuard], title: 'Edit User Push Token' },
  { path: 'userpushtoken/:userPushTokenId', component: UserPushTokenDetailComponent, canActivate: [AuthGuard], canDeactivate: [UnsavedChangesGuard], title: 'Edit User Push Token' },
  { path: 'userpushtoken', redirectTo: 'userpushtokens' },
  { path: 'userpushtokenchangehistories', component: UserPushTokenChangeHistoryListingComponent, canActivate: [AuthGuard], canDeactivate: [UnsavedChangesGuard], title: 'User Push Token Change Histories' },
  { path: 'userpushtokenchangehistories/new', component: UserPushTokenChangeHistoryDetailComponent, canActivate: [AuthGuard], canDeactivate: [UnsavedChangesGuard], title: 'Create User Push Token Change History' },
  { path: 'userpushtokenchangehistories/:userPushTokenChangeHistoryId', component: UserPushTokenChangeHistoryDetailComponent, canActivate: [AuthGuard], canDeactivate: [UnsavedChangesGuard], title: 'Edit User Push Token Change History' },
  { path: 'userpushtokenchangehistory/:userPushTokenChangeHistoryId', component: UserPushTokenChangeHistoryDetailComponent, canActivate: [AuthGuard], canDeactivate: [UnsavedChangesGuard], title: 'Edit User Push Token Change History' },
  { path: 'userpushtokenchangehistory', redirectTo: 'userpushtokenchangehistories' },
