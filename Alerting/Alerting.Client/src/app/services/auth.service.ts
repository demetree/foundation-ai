...
export class AuthService {
  ...
  ///
  /// Returns true if the current user is a Alerting Administrator
  ///
  get isAlertingAdministrator(): boolean {
    ...
    //
    // Deny any access if the user as the 'Alerting No Access' role
    //
    for (var i = 0; i < user.roles.length; i++) {
      if (user.roles[i] == "Alerting No Access") {
        return false;
      }
    }
    ...
    //
    for (var i = 0; i < user.roles.length; i++) {
      if (user.roles[i] == "Alerting Administrator") {
        return true;
      }
    }
  ...
  ///
  /// Returns true if the current user is a Alerting Reader and Writer
  ///
  get isAlertingReaderWriter(): boolean {
    ...
    //
    // Return true if the user is a 'Alerting Reader and Writer' or 'Alerting Administrator'
    //
    for (var i = 0; i < user.roles.length; i++) {
      if (user.roles[i] == "Alerting Administrator" ||
        user.roles[i] == "Alerting Reader and Writer") {
        return true;
      }
    }
  ...
  ///
  /// Returns true if the current user is a Alerting Reader
  ///
  get isAlertingReader(): boolean {
    ...
    //
    // Return true if the user is a 'Alerting Reader' or 'Alerting Reader and Writer' or 'Alerting Administrator'
    //
    for (var i = 0; i < user.roles.length; i++) {
      if (user.roles[i] == "Alerting Administrator" ||
        user.roles[i] == "Alerting Reader and Writer" ||
        user.roles[i] == "Alerting Reader") {
        return true;
      }
    }
