          ...
          setTimeout(() => {
            ...
            if (!this.isModal) {
              ...
              if (this.authService.isAlertingReader == false) {
                ...
                this.alertService.showMessage(this.gT('app.alerts.Login'), "Your account does not have the privilege to read from the Alerting system.", MessageSeverity.error);
