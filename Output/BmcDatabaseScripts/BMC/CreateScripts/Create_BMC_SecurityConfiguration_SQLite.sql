...
INSERT INTO "SecurityRole" ( "name", "description", "privilegeId" ) VALUES  ( 'BMC Community Writer', 'BMC Community Writer Role', ( SELECT id FROM "Privilege" WHERE "name" = 'Custom' LIMIT 1) );

INSERT INTO "SecurityRole" ( "name", "description", "privilegeId" ) VALUES  ( 'BMC Moderator', 'BMC Moderator Role', ( SELECT id FROM "Privilege" WHERE "name" = 'Custom' LIMIT 1) );
...
INSERT INTO "ModuleSecurityRole" ( "moduleId", "securityRoleId" ) VALUES  ( ( SELECT id FROM "Module" WHERE "name" = 'BMC' LIMIT 1), ( SELECT id FROM "SecurityRole" WHERE "name" = 'BMC Community Writer' LIMIT 1) );

INSERT INTO "ModuleSecurityRole" ( "moduleId", "securityRoleId" ) VALUES  ( ( SELECT id FROM "Module" WHERE "name" = 'BMC' LIMIT 1), ( SELECT id FROM "SecurityRole" WHERE "name" = 'BMC Moderator' LIMIT 1) );
