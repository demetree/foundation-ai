...
namespace Foundation.Telemetry.Database
{
	...
	public partial class TelemetryApplicationMetric : IAnonymousConvertible
	{
		...
		///
		/// </summary>
		public static Database.TelemetryApplicationMetric FromDTO(TelemetryApplicationMetricDTO dto)
		{
			return new Database.TelemetryApplicationMetric
			{
				id = dto.id,
		...
		///
		/// </summary>
		public static object CreateAnonymous(Database.TelemetryApplicationMetric telemetryApplicationMetric)
		{
			//
